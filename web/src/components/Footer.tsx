...
export default function Footer() {
  ...
  const footerLinks = {
    product: [
      ...
      { name: 'Documentation', href: DOCS_URLS.home, external: true },
      { name: 'Changelog', href: DOCS_URLS.changelog, external: true },
    ],
    company: [
    ...
    resources: [
      ...
      { name: 'FAQ', href: DOCS_URLS.faq, external: true },
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      href: 'https://github.com/EliteaAI',
      icon: (
