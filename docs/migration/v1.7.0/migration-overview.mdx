---
title: "Migration Guide: Upgrading to v1.7.0"
description: "This guide helps you migrate from earlier versions to ELITEA v1.7.0, focusing on the transition to the Next environment and key system changes."
---
...
**[Quick Start for Next Environment](./next-quick-start)**
...
**[Migrate Datasources to Indexing](./migrate-datasources-to-indexing)**
...
**[Configure EPAM AI DIAL Keys](../../getting-started/configure-epam-ai-dial-key)**
...
Read the [Release Notes](../../release-notes/archived/rn11) to understand all changes in v1.7.0.
...
See: [Create a Credential](../../getting-started/create-credential)
...
See: [Create a Toolkit](../../how-tos/chat-conversations/how-to-create-and-edit-toolkits-from-canvas)
...
See platform-specific guides in the [Migrate Datasources to Indexing](./migrate-datasources-to-indexing) guide.
...
See: [Configure EPAM AI DIAL Keys](../../getting-started/configure-epam-ai-dial-key)
...
Configure your own EPAM AI DIAL keys following the [Configure EPAM AI DIAL Keys](../../getting-started/configure-epam-ai-dial-key) guide.

## Getting Help

If you encounter issues during migration:

* **FAQs**: Check [Frequently Asked Questions](../../support/faqs)
* **Contact Support**: Email [SupportAlita@epam.com](mailto:SupportAlita@epam.com)
* **Documentation**: Browse [How-To Guides](../../how-tos/indexing/indexing-overview)
...
* [Release Notes - v1.7.0](../../release-notes/archived/rn11)
* [Indexing Overview](../../how-tos/indexing/indexing-overview)
* [Indexing Tools Reference](../../how-tos/indexing/indexing-tools)
* [How to Use Credentials](../../how-tos/credentials-toolkits/how-to-use-credentials)
* [Toolkits Menu Guide](../../menus/toolkits)

---

**Next Step:** Start with the [Quick Start for Next Environment](./next-quick-start) guide to begin your migration.
