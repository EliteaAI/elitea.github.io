---
title: "Next Environment Quick Start"
description: "The Next environment is a separate preview space for Release 1.7.0. It lets you explore new features safely using a point-in-time snapshot of your Nexus data."
---

## Overview

<Info title="Snapshot date and safe window">
...
* **Release Notes**: [Release 1.7.0](../../release-notes/archived/rn-1-7-0)
</Info>
...
1. Create and attach credentials
	...
	* Guides: [Create a Credential](../../getting-started/create-credential) · [Create a Toolkit](../../how-tos/chat-conversations/how-to-create-and-edit-toolkits-from-canvas) · [Use Credentials](../../how-tos/credentials-toolkits/how-to-use-credentials)
...
4. Check your conversations
	...
	* See: [Check your conversations](#check-your-conversations) · [Create a conversation](../../archive/create-conversation)
5. Index data for a toolkit
	* Use Tool Testing → Index Data to recreate datasets; parameters vary by toolkit.
	* See: [Index data for a toolkit](#index-data-for-a-toolkit) · Example: [Index GitHub data](../../how-tos/indexing/index-github-data)
...
6. Configure EPAM AI DIAL keys (strongly recommended)
	...
	* See: [Configure EPAM AI DIAL Keys](../../getting-started/configure-epam-ai-dial-key) · Settings → [AI Configuration](../../menus/settings/ai-configuration)
...
See the detailed guide: [Create a Credential and Add It to a Toolkit](../../getting-started/create-credential). For broader concepts, see [Use Credentials](../../how-tos/credentials-toolkits/how-to-use-credentials).
...
- For details, see: [Creating a Conversation and Adding AI Assistants](../../archive/create-conversation).
...
- You can also trigger indexing from an Agent or from Chat by selecting an Agent/Toolkit that has the Index Data tool available, then instructing it to index the target (provide repo/site/project and scope).
  - Example guide: [Index GitHub data](../../how-tos/indexing/index-github-data). Additional indexing guides will be added for other toolkits.
</Tip>
...
Full how-to: [Configure EPAM AI DIAL Keys](../../getting-started/configure-epam-ai-dial-key)

## Questions or issues? Contact Support

<Info title="Need help fast?">
...
See the full guidance: [How to Contact ELITEA Support](../../support/contact-support).
