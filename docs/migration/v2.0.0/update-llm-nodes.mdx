---
title: "Updating LLM Nodes in Pipelines"
description: "The LLM node structure has been updated with a new configuration format. If you have existing pipelines created before this change, you'll need to manually upda"
---
...
1. Navigate to **[Pipelines](../../menus/pipelines)** in the main menu
...
<Tip title="Migrating Your Old Prompt">
