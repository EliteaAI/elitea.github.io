---
title: "Migration Guide: Upgrading to v2.0.0"
description: "This guide helps you upgrade from v1.7.x to ELITEA v2.0.0, focusing on the critical LLM node updates required for existing pipelines."
---
...
**[Update LLM Nodes in Pipelines](./update-llm-nodes)**
...
- [Connect External Tools to Elitea with MCP](../../integrations/mcp/create-and-use-client-stdio)

**MCP Server (Use Elitea Agents in VS Code):**

- [Setting Up Your First MCP Server](../../integrations/mcp/create-and-use-server-stdio)
...
Read the [v2.0.0 release notes](../../release-notes/archived/rn-2-0-0) to understand all changes in v2.0.0.
...
**Detailed instructions:** [Update LLM Nodes in Pipelines](./update-llm-nodes)
...
See: 
- [MCP Client Guide (External Tools → Elitea)](../../integrations/mcp/create-and-use-client-stdio)
- [MCP Server Guide (Elitea Agents → VS Code)](../../integrations/mcp/create-and-use-server-stdio)
...
<Warning title="No Automatic Rollback">
...
* **Migration Guide**: [Update LLM Nodes in Pipelines](./update-llm-nodes)
* **FAQs**: [Frequently Asked Questions](../../support/faqs)
...
* [Release Notes - 2.0.0](../../release-notes/archived/rn-2-0-0)
* [Pipelines Menu Guide](../../menus/pipelines)
* [Connect External Tools to Elitea with MCP (Client)](../../integrations/mcp/create-and-use-client-stdio)
* [Setting Up MCP Server (Use Elitea in VS Code)](../../integrations/mcp/create-and-use-server-stdio)
* [MCPs Menu Guide](../../menus/mcps)
* [MCP Client Integration](../../integrations/mcp/create-and-use-client-stdio.mdx)

---

**Next Step:** Start with the [Update LLM Nodes in Pipelines](./update-llm-nodes) guide to migrate your pipelines.
