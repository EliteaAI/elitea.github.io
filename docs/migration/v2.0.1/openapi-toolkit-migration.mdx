---
title: "Migration Guide: Existing OpenAPI Toolkits to v2.0.0 B2"
description: "Starting with release 2.0.0 B2, the OpenAPI toolkit now requires explicit credential configuration for all toolkits. Previously configured toolkits must be upda"
---
...
4. **Create New Credential:** Click **New OpenAPI credentials** from the dropdown
   ...
   - For detailed authentication configuration instructions, see the [OpenAPI Toolkit Guide - Authentication Methods](../../integrations/toolkits/openapi_toolkit#authentication-methods-reference)
...
- Review the complete [OpenAPI Toolkit Integration Guide](../../integrations/toolkits/openapi_toolkit)
- Check the [Troubleshooting section](../../integrations/toolkits/openapi_toolkit#troubleshooting) for common issues
- Contact [ELITEA Support](../../support/contact-support) for assistance

<Info title="Related Documentation">
- [Credentials Management](../../menus/credentials)
- [Secrets Configuration](../../menus/settings/secrets)
</Info>
