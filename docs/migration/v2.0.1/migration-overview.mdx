---
title: "Migration Guide: Upgrading to v2.0.0 B2"
description: "Version 2.0.0 B2 introduces significant improvements to pipeline nodes, deprecating several legacy node types and replacing them with more specialized, easier-t"
---
...
<Warning title="Action Required for Existing Toolkits">
Existing OpenAPI toolkits will not function until credentials are configured. See the [OpenAPI Toolkit Migration Guide](./openapi-toolkit-migration) for step-by-step instructions.
</Warning>
...
<Info title="No Immediate Action Required">
Existing pipelines continue to function without saving. See the [Pipeline Save Button State Guide](./pipeline-save-button) for details.
</Info>
...
* [Condition Node Migration](./condition-node-migration) - Migrate to Router or Decision nodes
* [Function Node Migration](./function-node-migration) - Migrate to Toolkit or MCP nodes
* [Tool Node Migration](./tool-node-migration) - Migrate to Toolkit or MCP nodes
* [Pipeline Node Migration](./pipeline-node-migration) - Migrate to enhanced Agent node
* [Loop Node Migration](./loop-node-migration) - Use alternative design patterns

### Toolkit Migrations

* [OpenAPI Toolkit Migration](./openapi-toolkit-migration) - Add credentials to existing OpenAPI toolkits
* [Pandas Toolkit Migration](./pandas-toolkit-migration) - Migrate from Pandas toolkits to Data Analysis internal tool
...
<Info title="Manual Migration Required">
