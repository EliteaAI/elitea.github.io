---
title: "Tool Node Deprecation and Migration Guide"
description: "The Tool node has been deprecated as of version 2.0.1 and is no longer available for creating new pipelines. Starting with version 2.0.0 B2, you can no longer a"
---
...
<Warning title="Deprecation Timeline">
...
<Info title="ELITEA Vision: Use LLM Only When Needed">
...
<Warning title="Multiple Outputs Limitation">
...
<Info title="Key Differences in Toolkit Node">
...
<img src="../../img/migration/v2.0.1/tool-node/move-to-toolkit-node.gif" alt="Toolkit" />
...
- [YAML Configuration](../../how-tos/pipelines/yaml) - Complete YAML syntax and structure
- [Pipeline States](../../how-tos/pipelines/states) - Working with state variables
- [Pipeline Overview](../../how-tos/pipelines/overview) - Understanding pipeline concepts
- [Nodes and Connectors](../../how-tos/pipelines/nodes-connectors) - Node types and connections
- [Flow Editor Guide](../../how-tos/pipelines/flow-editor) - Visual pipeline editing
- [Execution Nodes](../../how-tos/pipelines/nodes/execution-nodes) - Toolkit and other execution nodes
</Info>
...
<Tip title="Feature Request: Built-in Global Config">
...
- **LLM Node**: [LLM Node Documentation](../../how-tos/pipelines/nodes/interaction-nodes#llm-node)
- **Toolkit Node**: [Toolkit Node Documentation](../../how-tos/pipelines/nodes/execution-nodes#toolkit-node)
- **State Modifier Node**: [State Modifier Node Documentation](../../how-tos/pipelines/nodes/utility-nodes#state-modifier-node)
- **Code Node**: [Code Node Documentation](../../how-tos/pipelines/nodes/execution-nodes#code-node)
- **Agent Node**: [Agent Node Documentation](../../how-tos/pipelines/nodes/interaction-nodes#agent-node)
- **All Node Types**: [Nodes Overview](../../how-tos/pipelines/nodes/overview)
- **Pipeline States**: [Working with Pipeline States](../../how-tos/pipelines/states)
- **YAML Configuration**: [YAML Configuration Guide](../../how-tos/pipelines/yaml)
