---
title: "Pipeline Save Button State Change"
description: "Starting from version 2.0.1, the Save button in pipeline configuration is now active immediately when you open an existing pipeline for the first time. This cha"
---

## Overview

<Info title="What Changed">
...
* **[Loop Node](./loop-node-migration)** - Deprecated in favor of Router-based loop patterns
* **[Loop for Tool Node](./loop-node-migration)** - Deprecated in favor of Router-based loop patterns  
* **[Function Node](./function-node-migration)** - Deprecated in favor of Code Node
* **[Condition Node](./condition-node-migration)** - Deprecated in favor of Router Node
* **[Tool Node](./tool-node-migration)** - Deprecated in favor of Toolkit Node
* **[Pipeline (Subgraph) Node](./pipeline-node-migration)** - Deprecated in favor of direct agent/pipeline toolkit integration
...
<Accordion title="Viewing Deprecated Nodes">
...
<Accordion title="Why is the Save button active even though I didn't make changes?">
...
<Accordion title="Do I need to save every pipeline immediately?">
...
<Accordion title="What happens if I click Save without making changes?">
...
<Accordion title="Will my pipeline break if I don't save?">
...
<Accordion title="Where did the Run tab go?">
...
<Accordion title="How do I know if my pipeline has deprecated nodes?">
...
* **[Pipeline Runs](../../how-tos/pipelines/pipeline-runs)** - Complete guide to monitoring pipeline execution
* **[Flow Editor](../../how-tos/pipelines/flow-editor)** - Visual pipeline design interface
* **[LLM Node](../../how-tos/pipelines/nodes/interaction-nodes#llm-node)** - Updated LLM node documentation
* **[Chat Interface](../../how-tos/chat-conversations/how-to-create-and-edit-pipelines-from-canvas)** - Testing pipelines from Chat
* **[Deprecated Nodes Overview](../../how-tos/pipelines/nodes/overview#deprecated-nodes)** - List of all deprecated node types
</Info>
