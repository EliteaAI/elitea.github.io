---
title: "Migrating from Pipeline Node to Agent Node"
description: "The Pipeline Node has been deprecated and is no longer available for creation in new pipelines. While existing Pipeline nodes in your pipelines will continue to"
---
...
* **[Agent Node](../../how-tos/pipelines/nodes/interaction-nodes#agent-node)** - Detailed Agent node documentation
