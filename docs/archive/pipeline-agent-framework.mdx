...
description: "Welcome to the Pipeline Agent Framework guide for ELITEA! This guide will help you understand how to create your own intelligent agents within ELITEA, even if y"
tag: "Legacy"
...
![Pipeline-Create_Agent](<../img/archive/features/pipelines/Pipeline-Create_Agent.png>)
...
To learn more about building Pipeline Agents, explore these related guides and references:

* **[ELITEA Agents Configuration](../menus/agents.mdx)**: Learn more about configuring and managing agents within ELITEA.
