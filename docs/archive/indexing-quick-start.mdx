---
title: "Indexing Quick Start"
sidebarTitle: "Indexing Quick Start"
description: "Get started with the new Indexing Tab interface in just a few minutes. This guide shows you how to create your first index and start searching your data."
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Indexing](../how-tos/indexing/indexing-overview) for up-to-date content.
</Warning>
...
- ✅ **PgVector configured** - Set up in [AI Configuration](../menus/settings/ai-configuration)
...
- **[Indexing Overview](../how-tos/indexing/indexing-overview)** - General concepts and getting started
- **[Complete User Guide](../how-tos/indexing/using-indexes-tab-interface)** - Detailed interface documentation
- **[Indexing Tools](../how-tos/indexing/indexing-tools)** - Advanced search parameters
</Info>