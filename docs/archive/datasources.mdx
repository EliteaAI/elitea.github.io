---
title: "Datasources"
sidebarTitle: "Datasources"
description: "Datasources play a pivotal role in broadening and enriching the functionalities of ELITEA and AI technologies. They enable the extension of LLMs by integrating "
tag: "Legacy"
...
* **API Key** -  Required for Jira dataset.
    * Input your Jira API Key manually or select a pre-configured secret from the **[ELITEA Secrets Management](../menus/settings/secrets)**
