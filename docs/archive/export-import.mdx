---
title: "Export and Import Guide: Managing Prompts, Datasources, and Agents for Backup, Migration, and Collaboration"
sidebarTitle: "Export & Import"
description: "This user guide provides a comprehensive overview of the Export and Import features within ELITEA. These powerful functionalities allow you to seamlessly transf"
tag: "Legacy"
...
![Export-Table_view](<../img/archive/features/export-import/Export-Table_view.png>)
...
![Prompt-Export](<../img/archive/features/export-import/Prompt-Export.png>)
...
![Prompt-Exported_File](<../img/archive/features/export-import/Prompt-Exported_File.png>)
...
![Datasource-Export](<../img/archive/features/export-import/Datasource-Export.png>)
...
![Agent-Export](<../img/archive/features/export-import/Agent-Export.png>)
...
![Collection-Export](<../img/archive/features/export-import/Collection-Export.png>)
...
![Import-Button](<../img/archive/features/export-import/Import-Button.png>)
...
![Prompt-Import_Wizard](<../img/archive/features/export-import/Prompt-Import_Wizard.png>)
...
![Datasource-Import_Wizard](<../img/archive/features/export-import/Datasource-Import_Wizard.png>)

![Datasource-Reindex](<../img/archive/features/export-import/Datasource-Reindex.png>)
...
![Agent-Import_Wizard](<../img/archive/features/export-import/Agent-Import_Wizard.png>)
...
![MasterAgent-Import_Wizard](<../img/archive/features/export-import/MasterAgent-Import_Wizard.png>)
...
![Collection-Import](<../img/archive/features/export-import/Collection-Import.png>)
