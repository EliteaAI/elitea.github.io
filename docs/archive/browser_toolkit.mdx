---
title: "ELITEA Toolkit Guide: Browser Integration"
sidebarTitle: "Browser Toolkit"
description: "This guide is your definitive resource for integrating and effectively utilizing the Browser toolkit within ELITEA. It provides a detailed, step-by-step walkthr"
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Toolkits](../menus/toolkits) for up-to-date content.
</Warning>
...
<Info title="Google Tool Optional">
...
*   **[ELITEA Secrets Management](../menus/settings/secrets)**: Learn how to securely store your Zephyr Scale API Token using ELITEA's Secrets management feature for enhanced security.
*   **[ELITEA Agents Configuration](../menus/agents)**:  Find out more about creating and configuring Agents in ELITEA, where you integrate the Zephyr Scale toolkit to automate your workflows.
