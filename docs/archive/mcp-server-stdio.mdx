---
title: "Connect to Elitea MCP Server via STDIO"
sidebarTitle: "Elitea MCP Server (STDIO)"
description: "Connect VS Code to Elitea's MCP server over STDIO using the alita-mcp client, your project ID, and an authentication token."
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Set Up a Local MCP Server (STDIO)](../integrations/mcp/create-and-use-server-stdio.mdx) for up-to-date content.
</Warning>

## Overview, making it ideal for script-based workflows, automation, and environments where HTTP connections may not be practical. Whether you're using Visual Studio Code or another MCP client, this guide will walk you through connecting and leveraging Elitea's MCP Server capabilities via STDIO.
...
- See the [SSE Transport guide](../integrations/mcp/mcp-server-sse.mdx) for details
...
- [ELITEA Documentation Home](../home/introduction)
- [ELITEA Settings & Configuration](../menus/settings/ai-configuration)
- [ELITEA SSE Transport Integration](../integrations/mcp/mcp-server-sse)
- [ELITEA Support](../support/contact-support)
