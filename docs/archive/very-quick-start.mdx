---
title: "Very Quick Start with ELITEA"
sidebarTitle: "Very Quick Start"
description: "Get up and running in just a few minutes. Follow these minimal steps, then dive deeper when you’re ready."
tag: "Legacy"
...
<Info title="Reference">
For more information, see the [Chat Guide](../menus/chat).
</Info>
...
* **[Create a Secret](../getting-started/create-secret)** - Secure storage for API keys and passwords
* **[Create a Personal Access Token](../getting-started/create-personal-access-token)** - Generate tokens for API access
