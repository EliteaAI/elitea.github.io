...
tag: "Legacy"
sidebarTitle: "ELITEA & AI Dial"
description: "Welcome to the user-friendly manual on using ELITEA and EPAM AI Dial seamlessly together. This guide walks you through the steps to export from one platform and"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Configure EPAM AI DIAL Keys](../getting-started/configure-epam-ai-dial-key) for up-to-date content.
</Warning>
