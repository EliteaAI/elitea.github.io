...
description: "ELITEA Pipelines are powerful workflow automation tools that visually design and execute sequences of states and actions. Each pipeline is designed to handle sp"
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Pipelines](../menus/pipelines) for up-to-date content.
</Warning>
...
For detailed information on creating and managing toolkits, refer to the **[Toolkits Menu Guide](../menus/toolkits)**.
</Info>
...
<Tip title="Conversation Benefits">
...
<Info title="Reference">
For detailed instructions on creating a conversation, refer to the [Create first Conversation](../archive/create-conversation) guide.
</Info>
...
* **[Pipelines Menu Guide](../menus/pipelines)** - Comprehensive pipeline documentation
* **[Chat Menu Guide](../menus/chat)** - Learn about conversations and collaboration
* **[Create a Toolkit](./create-toolkit)** - Learn to integrate external services
* **[Create Credentials](../getting-started/create-credential)** - Set up secure authentication
* **[Pipeline Agent Framework](../features/pipelines/pipeline-agent-framework)** - Advanced pipeline development
* **[Glossary](../home/glossary)** - Definitions of key terms and concepts
</Info>
