...
sidebarTitle: "Manage Users & Roles"
description: "To configure or modify the admin settings for a specific project:"
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Users & Roles Settings](../menus/settings/users) for up-to-date content.
</Warning>
