---
title: "Creating a Conversation and Adding AI Assistants (Agents, Pipelines and Toolkits) into Conversation"
sidebarTitle: "Create a Conversation"
description: "Your new conversation will appear in the conversation list on the left."
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Chat Functionality](../how-tos/chat-conversations/how-to-use-chat-functionality) for up-to-date content.
</Warning>
...
* [How to Use Chat Functionality](../how-tos/chat-conversations/how-to-use-chat-functionality)
