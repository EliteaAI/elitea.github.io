---
title: "Quick Start with ELITEA"
sidebarTitle: "Quick Start"
description: "Welcome to ELITEA! This guide will help you quickly get up and running with the platform, from your first login to creating your first AI-powered agent. Follow "
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Quick Start](../getting-started/chat-quick-start) for up-to-date content.
</Warning>
...
For more information, see the [Personal Access Tokens Guide](../getting-started/create-personal-access-token) and [Elitea Code Extensions](../integrations/extensions/elitea-code).
</Info>
...
<Info title="Reference">
For more information, see the [Secrets Management](../menus/settings/secrets)
</Info>
...
<Info title="Reference">
For more information, see the [Credentials Guide](../menus/credentials)
</Info>
...
<Info title="Reference">
For more information, see the [Toolkits Guide](../menus/toolkits).
</Info>
...
<Info title="Reference">
For more information, see the [Agents Documentation](../menus/agents).
</Info>
...
<Info title="Reference">
For detailed pipeline creation with YAML instructions and advanced flow configurations, refer to the [Pipeline Agent Framework User Guide](../features/pipelines/pipeline-agent-framework) or [Pipelines Documentation](../menus/pipelines).
</Info>
...
<Info title="Reference">
For more information, see the [Chat Documentation](../menus/chat).
</Info>
