...
<Info title="Reference">
For detailed pipeline creation with YAML instructions and advanced flow configurations, refer to the [Pipeline Agent Framework User Guide](./pipeline-agent-framework) or [Pipelines Documentation](../menus/pipelines).
</Info>
