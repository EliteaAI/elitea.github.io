---
title: "Create a Toolkit and Add It to an Agent"
sidebarTitle: "Create a Toolkit"
description: "Toolkits in ELITEA are the building blocks that empower your agents to interact with external systems like GitHub, Jira, Azure DevOps, and more. Assigning toolk"
tag: "Legacy"
...
For detailed instructions on creating credentials, refer to the [Create Credentials](../menus/credentials) document.
</Info>
---
...
* **[Agents](../menus/agents)** — Configure agents and assign toolkits to enable automated workflows
* **[Credentials](../menus/credentials)** — Learn how to create and manage credentials used by toolkits
</Info>