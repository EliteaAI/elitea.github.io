...
description: "The Collections menu within Private workspace and Team projects in ELITEA serves as your central hub for organizing and managing your Collections. Think of it a"
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Working with Pins](../how-tos/entity-management/working-with-pins) for up-to-date content.
</Warning>
...
For more information about importing collections and entities, please refer to the [Export & Import Entities](../features/export-import).
</Info>
