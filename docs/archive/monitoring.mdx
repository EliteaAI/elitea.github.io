...
description: "The Monitoring feature in ELITEA provides insights into application usage and performance. Access monitoring through the Settings menu to analyze user engagemen"
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Analytics](../menus/settings/analytics) for up-to-date content.
</Warning>
...
<img src="../img/archive/monitoring/access-monitoring.gif" alt="Monitoring" />
...
* **Active Users**: Bar chart showing active and inactive users over time
      ...
      <img src="../img/archive/monitoring/active-users.png" alt="Users" width="350" />

* **Token Usage**: Line chart showing token consumption and generation
      - Displays "Tokens in" and "Tokens out" metrics over time
      - X-axis: Date (formatted based on aggregation period)
      <img src="../img/archive/monitoring/token-usage.png" alt="Token" width="350" />
...
- Shows trends in output acceptance
 ...
 <img src="../img/archive/monitoring/acceptance-rate.png" alt="Acceptance Rate" width="450" />

<Info title="Chart Visibility">
...
<img src="../img/archive/monitoring/export-raw-data.gif" alt="Export Raw Data" width="550" />
...
<img src="../img/archive/monitoring/export-acceptance-data.gif" alt="Export Raw Data" width="550" />
...
<Accordion title="Use Project Groups for Portfolio Management">
...
<Accordion title="Configure Filters Before Refreshing">
...
<Accordion title="Choose Appropriate Aggregation Periods">
...
<Accordion title="Monitor Acceptance Rate Regularly">
...
<Accordion title="Export Data for Historical Analysis">
...
<Accordion title="Use Sentiment Analysis for Quality Insights">
...
<Accordion title="Leverage Session Storage for Workflow Efficiency">
