...
description: "ELITEA Agents are customizable virtual assistants that automate tasks and streamline workflows. Each agent is tailored to handle specific tasks based on the ins"
tag: "Legacy"
hideFooterPagination: true
---

<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Agents](../menus/agents) for up-to-date content.
</Warning>
...
For detailed instructions on creating toolkits, refer to the [Create a Toolkit](./create-toolkit) guide.
</Info>
...
<Info title="Reference">
For detailed instructions on creating conversation, refer to the [Create first Conversation](../archive/create-conversation) guide.
</Info>
---
...
* **[Agents Menu Guide](../menus/agents)** - Comprehensive agent documentation
...
* **[Chat Menu Guide](../menus/chat)** - Comprehensive chat documentation
