...
description: "Personal access tokens are secure \"credentials\" used to authenticate yourself and your applications to ELITEA’s backend services. These tokens act as your dig"
---
...
3. **Configure Your Environment:**
      * Follow the [Elitea Code Documentation](../integrations/extensions/elitea-code) for detailed instructions on adding your personal access token to your development environment.
...
* **Integration setup issues?** Refer to the [Elitea Code Documentation](../integrations/extensions/elitea-code) or contact your administrator.
