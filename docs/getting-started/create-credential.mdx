---
title: "Create a Credential and Add It to a Toolkit"
description: "Integrating external services with ELITEA requires secure authentication and configuration. This is achieved by creating Credentials (for API keys, tokens, or l"
---
