---
title: "Create an Artifact Using an Agent"
description: "Artifacts in ELITEA are files (such as .txt, .md, .csv, .json, etc.) stored in project-specific buckets. Using the Artifact Toolkit with an Agent allows you to "
---
...
* See the [full Artifact Toolkit Guide](../integrations/toolkits/artifact_toolkit) for advanced details and use cases.
