...
description: "Hello there! 👋 We're thrilled you're here. Whether you're an experienced user or just starting your journey with ELITEA, questions might pop up, and that's perf"
---
...
**For more information**: please check [Datasources - Confluence setup](../archive/datasources#source-type---confluence).
