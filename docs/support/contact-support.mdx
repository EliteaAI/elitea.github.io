...
EPAM users can also get help directly through the **ELITEA Bot** in Microsoft Teams. The bot is available **24/7**, has access to the full ELITEA documentation, and can assist with questions, troubleshooting, and guidance.
