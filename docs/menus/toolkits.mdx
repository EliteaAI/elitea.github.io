...
Folders help you organize toolkits into logical groups for better navigation and management. You can create folders, move toolkits between folders, and control folder access within team projects.

![Toolkits folders panel](../img/menus/toolkits/folders-panel.png)

**Create a Folder:**

1. In the **Toolkits** dashboard right panel, locate the **Folders** section.
2. Select **+ Create Folder**.
3. Enter a folder name (up to 128 characters).
4. Select **Create**.

     <img src="../img/menus/toolkits/folder-create.png" alt="Create folder" width="430" />

**Move a Toolkit to a Folder:**
...
4. The toolkit is moved to the selected folder
    ...
    <img src="../img/menus/toolkits/add-to-folder.png" alt="Add to folder" width="430" />
...
Click any folder in the Folders panel to filter the toolkit list to show only toolkits in that folder. The folder name appears in the header, and the toolkit count updates to reflect the filtered view. Click **X** to close the folder view and return to the full list.
    ...
    <img src="../img/menus/toolkits/folder-content.png" alt="Folder content" />

**Manage Folders:**

Each folder card in the right panel has a three-dot menu (⋮) with the following options:
    <img src="../img/menus/toolkits/manage-folder.png" alt="Folder actions" width="200" />
| Action | Description |
| --- | --- |
| **Rename** | Change the folder name |
| **Pin to top** | Pin the folder to the top of the folders list |
| **Delete** | Permanently remove the folder (toolkits inside are moved back to the main list, not deleted) |
| **Manage Access** *(Team projects only)* | Control which team members can view the folder |

**Remove a Toolkit from a Folder:**

1. Open the toolkit card's three-dot menu (⋮).
2. Select **Remove from Folder**.
3. The toolkit returns to the main toolkits list and the folder icon is removed from its card.
...
1. In the **Toolkits** dashboard right panel, locate the folder in the **Folders** list.
2. Select the folder's three-dot menu (⋮).
3. Select **Manage Access**.
4. The Manage Permissions dialog opens.

    <img src="../img/menus/toolkits/folder-permissions-open.png" alt="Folder permissions open" width="500" />
...
4. Select **Add**. The selected users are added to the permissions table.
    ...
    <img src="../img/menus/toolkits/folder-add-exceptions.png" alt="Folder add exceptions" width="500" />
...
| **Read-only** | User can view folder contents but cannot modify folder settings or move toolkits |
