---
title: "MCPs"
description: "The MCPs menu in the ELITEA platform provides a centralized interface for managing and configuring Model Context Protocol (MCP) servers that extend your AI agen"
---
...
<img src="../img/menus/mcps/mcp-menu-open.png" alt="MCPs Menu Interface" />
...
4. Click the pin icon again to unpin the MCP
     ...
     <img src="../img/menus/mcps/mcp-pin.gif" alt="MCP Pin" />
...
* **Connected** (Grey) - Active connection; tools are available for use
     ...
     <img src="../img/menus/mcps/connected.png" alt="Connected" width="250" />

* **Disconnected** (Orange) - MCP exists but cannot reach server; tools unavailable

     <img src="../img/menus/mcps/disconnected.png" alt="Disconnected" width="250" />
---
...
For detailed setup instructions, see the **[MCP Client Integration Guide](../integrations/mcp/create-and-use-client-stdio)**.
...
For detailed setup instructions, see the **[Remote MCP Integration Guide](../integrations/mcp/create-and-use-remote-mcp)**.

---

## Organize MCPs with Folders

Folders help you organize MCPs into logical groups for better navigation and management. You can create folders, move MCPs between folders, and control folder access within team projects.

![MCP folder section](../img/menus/folders/folder-section.png)

**Create a Folder:**

1. In the **MCPs** dashboard right panel, locate the **Folders** section.
...
**Move an MCP to a Folder:**

1. **Hover over an MCP card:** A "Move to folder" icon (folder with arrow) appears on the card.
...
4. The MCP is moved to the selected folder.

    <img src="../img/menus/folders/add-to-folder.png" alt="Add to folder" width="430" />

**View Folder Contents:**

Click any folder in the Folders panel to filter the MCPs list to show only MCPs in that folder. The folder name appears in the header, and the MCPs count updates to reflect the filtered view. Click **X** to close the folder view and return to the full list.

    <img src="../img/menus/mcps/folder-content-mcp.png" alt="Folder content" />
...
| **Delete** | Permanently remove the folder (MCPs inside are moved back to the main list, not deleted) |
| **Manage Access** *(Team projects only)* | Control which team members can view the folder |

**Remove an MCP from a Folder:**

1. Open the MCP card's three-dot menu (⋮).
2. Select **Remove from Folder**.
3. The MCP returns to the main MCPs list and the folder icon is removed from its card.
...
1. In the **MCPs** dashboard right panel, locate the folder in the **Folders** list.
...
| **Read-only** | User can view folder contents but cannot modify folder settings or move MCPs |
...
If no local MCP servers are available, you'll see a message: **"Still no local MCP available. Follow creation guides in our [Documentation](../integrations/mcp/create-and-use-client-stdio)."** with a link redirecting you to the MCP Client Integration Guide for installation and setup instructions.
</Warning>

	<img src="../img/menus/mcps/mcp-run-notification.png" alt="MCP" width="450" />
...
5. **TOOLS** - Select which specific tools and actions to enable for this MCP
    ...
    * **[Make Tools Available by MCP](../integrations/mcp/make-tools-available-by-mcp)** - (optional checkbox) Enable this option to make the selected tools accessible through the external MCP clients to use the toolkit's capabilities
6. **Click `Create`** to finalize. The new MCP card appears in your dashboard with its current connection status.

    <img src="../img/menus/mcps/local-mcp-create.gif" alt="Local MCP Configuration" />
...
<Info title="Detailed Configuration Guide">
For comprehensive setup instructions, authentication methods, real-world examples (GitHub, Atlassian), and troubleshooting, see the **[Remote MCP Integration Guide](../integrations/mcp/create-and-use-remote-mcp)**.
</Info>
...
<img src="../img/menus/mcps/mcp-run-tab.png" alt="MCP Run Tab" />
...
<Info title="Local MCP Configuration">
...
<Tip title="Least Privilege Principle">
...
4. **Execute the tool:** Click the **RUN TOOL** button and review the results in the output area. `(The RUN TOOL button appears after selecting a tool.)`
     ...
     <img src="../img/menus/mcps/test-mcp-tools.gif" alt="MCP Test Tools" />
...
For detailed instructions on using the History panel, see the **[Toolkit History Tab Guide](../how-tos/credentials-toolkits/toolkit_history_tab)**.
</Info>
...
1. Navigate to the **[Agents](./agents)** menu.
...
1. Navigate to the **[Pipelines](./pipelines)** menu.
...
<Accordion title="Enable Only Required Tools">
...
<Accordion title="Use Clear and Consistent Naming">
...
<Accordion title="Monitor Connection Status Regularly">
...
<Accordion title="Test After Server Updates">
...
<Accordion title="MCP Shows Disconnected Status">
**Symptoms:**
...
<Accordion title="Tools Not Appearing in List">
**Symptoms:**
...
<Accordion title="Tool Invocation Fails During Execution">
**Symptoms:**
...
If you encounter issues not covered in this guide or need additional assistance with MCP management, please refer to **[Contact Support](../support/contact-support)** for detailed information on how to reach the ELITEA Support Team.

---

<Info title="Additional Resources">
* **[MCP Server Integration Guide](../integrations/mcp/create-and-use-server-stdio)** – Create and configure MCP servers with STDIO transport
* **[Toolkits](./toolkits)** – Native toolkit integrations and configurations
* **[Testing Toolkit Functionality](../how-tos/credentials-toolkits/how-to-test-toolkit-tools)** – Comprehensive testing guide for tools and MCPs
</Info>
