...
- **Left panel** — the configuration form with all settings sections (General, Instructions, Variables, Welcome Message, Toolkits, Skills, Conversation Starters, Advanced, Information)
