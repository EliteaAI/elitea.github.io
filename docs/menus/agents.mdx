...
| [**ELITEA MCP Tools**](../how-tos/chat-conversations/agents-&-pipeline-builder) | Exposes ELITEA platform capabilities as MCP tools, allowing the agent to interact with ELITEA resources (agents, skills, pipelines, etc.) directly during execution. |
