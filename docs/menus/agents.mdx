...
The **Publish** functionality allows you to make a specific `Draft` version of your agent available in [Agent HUB](./agents-studio) — a shared library accessible to all users in your ELITEA installation. Publishing uses a guided three-step wizard with **AI-powered automated validation** that checks your agent before it can be submitted.
...
- Community users can find and use the agent in Agent HUB without needing project access.
