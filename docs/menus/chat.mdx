...
<CardGroup cols={2}>
  ...
  <Card title="Agent & Pipeline Builder" type="note" icon="server" href="../how-tos/chat-conversations/elitea-mcp-tools-internal-tool">
...
* **Edit**: To rename a conversation, on the left panel, in the conversation contextual menu, select **Edit** and confirm your action. Only the conversation author can rename their own conversation.
...
* **Export**: To export a single conversation, on the left panel, in the conversation contextual menu, point to Export. `(Not available — coming in future updates.)`
