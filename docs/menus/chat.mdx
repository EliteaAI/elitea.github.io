...
<img src="../img/menus/chat/chat_participants_users.png" width="250" alt="." />
...
* **Collapsed view**: Shows a simple line indicating the token usage status (green for normal, orange for high usage)
  ...
  <img src="../img/menus/chat/chat_context-budget_collapsed.png" alt="." />

* **Compact view**: Displays pruning strategy, message count, summaries count, and an expand button

  <img src="../img/menus/chat/chat_context-budget_compact.png" width="250" alt="." />
...
* **Configuration view**: Allows you to set context management parameters, including max context tokens, message preservation, pruning strategy, and summarization settings
  ...
  <img src="../img/menus/chat/chat_context-budget_configuration.png" width="450" alt="." />
...
<img src="../img/menus/chat/chat_clarify.png" alt="." />
...
<img src="../img/menus/chat/chat_follow-up-suggestions.png" alt="." />
...
<img src="../img/menus/chat/chat_generated-open-in-canvas.png" alt="." />
