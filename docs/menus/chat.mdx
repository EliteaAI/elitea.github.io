...
In team projects, you can invite exact members of your team to cooperate in the conversation. These users are invited from the **+** button in the message input toolbar and are listed in the **PARTICIPANTS** panel as Users:
...
**Context Budget** widget displays real-time token usage metrics and allows you to configure how the system manages conversation context as it approaches model token limits.
...
Besides opening in Canvas, generated entities are displayed as chips in the chat message. You can interact with it directly from the chat:
