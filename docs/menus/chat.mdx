...
| [Skill Builder](../how-tos/modules/skill-builder.mdx) | Create and edit skills directly from the chat. |
| [Project Context Builder](../how-tos/modules/project-context-builder.mdx) | Create and edit your project context directly from the chat. |
| [Ask User](../how-tos/modules/ask-user.mdx) | Allow agents to pause and ask you clarifying questions instead of guessing. |
...
Default modules are configured by project administrators in [General Settings → Default Modules](./settings/general#default-modules).
