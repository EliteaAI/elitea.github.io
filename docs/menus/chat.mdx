...
You can add participants before sending your first message. Click the **`+`** icon in the input toolbar to access agents, pipelines, toolkits, MCPs, internal tools, and file attachments — or type **`#`** followed by a name to search directly.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Elitea MCP Tools" type="note" icon="server" href="../how-tos/chat-conversations/elitea-mcp-tools-internal-tool">
    Enable built-in ELITEA platform MCP tools for managing agents, pipelines, chat, and toolkits directly from within conversations — without switching to a separate configuration screen.
  </Card>
</CardGroup>
