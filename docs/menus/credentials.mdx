---
title: "Credentials"
description: "The Credentials menu in the ELITEA platform provides a secure and centralized interface for managing the authentication details and access tokens needed to conn"
---
...
<img src="../img//menus/credentials/credentials-menu-open.png" alt="Credentials-Menu_Interface" />
...
<img src="../img//menus/credentials/credentials-view.gif" alt="Credentials-Menu_Interface" />
...
<img src="../img//menus/credentials/credentials-filter.gif" alt="Credentials-Menu_Interface" />
...
<img src="../img//menus/credentials/credentials-pin.gif" alt="Credentials-Menu_Interface" />
...
Folders help you organize credentials into logical groups for better navigation and management. You can create folders, move credentials between folders, and control folder access within team projects.

![Credential folder section](../img/menus/folders/folder-section.png)

**Create a Folder:**

1. In the **Credentials** dashboard right panel, locate the **Folders** section.
...
**Move a Credential to a Folder:**

1. **Hover over a Credential card:** A "Move to folder" icon (folder with arrow) appears on the card.
...
4. The Credential is moved to the selected folder.

    <img src="../img/menus/folders/add-to-folder.png" alt="Add to folder" width="430" />

**View Folder Contents:**

Click any folder in the Folders panel to filter the credentials list to show only credentials in that folder. The folder name appears in the header, and the credentials count updates to reflect the filtered view. Click **X** to close the folder view and return to the full list.

    <img src="../img/menus/credentials/folder-content-credential.png" alt="Folder content" />
...
| **Delete** | Permanently remove the folder (credentials inside are moved back to the main list, not deleted) |
| **Manage Access** *(Team projects only)* | Control which team members can view the folder |

**Remove a Credential from a Folder:**

1. Open the credential card's three-dot menu (⋮).
2. Select **Remove from Folder**.
3. The Credential returns to the main credentials list and the folder icon is removed from its card.
...
1. In the **Credentials** dashboard right panel, locate the folder in the **Folders** list.
...
| **Read-only** | User can view folder contents but cannot modify folder settings or move credentials |
...
<img src="../img//menus/credentials/credentials-create.gif" alt="Credentials-Create" />
...
<img src="../img//menus/credentials/credentials-select.gif" alt="Credentials-Create" />
...
<Warning title="Security Recommendation">
When prompted for sensitive information like API keys, passwords, or tokens, it's recommended to use **[Secrets](./settings/secrets)** instead of entering plain text values. Secrets provide enhanced security for your sensitive data. When the field is switched to **Secret**, you can also create a new secret directly from the dropdown by selecting **New Project Secret** or **New Private Secret**.
</Warning>

<img src="../img//menus/credentials/credentials-config.png" alt="Credentials-Create" />

<Tip title="Tip">
The exact fields required for each credential depend on the integration type. For detailed setup instructions for each credential type, see the [How to Use Credentials](../how-tos/credentials-toolkits/how-to-use-credentials) guide.
</Tip>
...
<img src="../img/menus/credentials/credentials-test-save.gif" alt="Save" />
...
<img src="../img/menus/credentials/credentials-manage.png" alt="Credentials-Edit" />
...
For more information on creating and managing Toolkits, see the [Toolkits documentation](../how-tos/chat-conversations/how-to-create-and-edit-toolkits-from-canvas)
</Info>
...
<Accordion title="Failed Authentication">
...
<Accordion title="Credential Not Appearing">
...
<Accordion title="Toolkit/Agent Cannot Use Credential">
...
If you encounter issues not covered in this guide or need additional assistance with credential management, please refer to **[Contact Support](../support/contact-support)** for detailed information on how to reach the ELITEA Support Team.
...
* **[Toolkits](../menus/toolkits)** — Complete guide to the Toolkits menu interface and advanced configuration options
* **[How to Use Credentials](../how-tos/credentials-toolkits/how-to-use-credentials)** — Step-by-step guide for creating and managing credentials
