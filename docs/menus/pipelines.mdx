...
<img src="../img/menus/pipeline/pipeline-menu-navigation.gif" alt="Pipeline_Menu" />
...
3. Toggle the **Attachments** switch to the on position.
4. Click **Save** to apply the change.

![Enable Attachments](../img/menus/pipeline/pipeline-attachments-enable.gif)
...
3. Click **Save** to confirm your entry. 
     ...
     <img src="../img/menus/pipeline/pipeline-save-version.gif" alt="Pipeline New Version" />
