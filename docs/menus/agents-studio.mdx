...
This table compares the **Catalog** and **Agents** menus.
...
<img src="../img/menus/catalog/catalog_find.png" width="200" alt="Finding the Catalog menu in the ELITEA sidebar." />
...
Each tab includes the number of published agents or skills:

<img src="../img/menus/catalog/catalog_number.png" width="400" alt="Number of published agents and skills in each tab." />

In each tab — **Agents** or **Skills** — you can:

- Search for published items using the **Search** field.
- Browse reusable agents and skills from the ELITEA community.
- Open agent or skill details from the catalog card.

Published agents and skills are displayed as cards in a responsive grid layout, grouped by their assigned categories. Each card provides key agent or skill information:

- Display name.
- Profile image of the creator.
- Number of likes received. The heart icon is filled if you've liked the agent or skill.
- **New** label for recently published items.

<img src="../img/menus/catalog/catalog_card.png" width="500" alt="Agent card in the Catalog." />

From the card, you can:

- Open the agent or skill details.
- Like or unlike the agent or skill.

## Agents in Catalog

Published agents are available in Catalog in the **Agents** tab.
...
- **Show instructions:** Select to open a read-only dialog displaying the agent's full instructions and configuration details. You can read and copy the instructions but cannot modify them.
...
<img src="../img/menus/catalog/catalog-agent-details.png" width="475" alt="Agent detail dialog showing creator, description, instructions, and Start chat button." />
...
Published skills are available in Catalog in the **Skills** tab.
...
<img src="../img/menus/catalog/catalog-skill-details.png" width="475" alt="Skill details view showing creator, description, and read-only instructions." />
...
These filters help you browse catalog items by their assigned categories:

| Category | Description |
|----------|-------------|
| **Trending** | Catalog items with the most likes from the community |
| **My liked** | Catalog items you have personally liked |
| **New** | Recently added catalog items |
| **Business analyst** | Catalog items designed for business analysis tasks |
| **DevOps** | Catalog items designed for DevOps tasks |
| **Development** | Catalog items focused on software development and coding |
| **Elitea** | Platform-specific catalog items for ELITEA workflows |
| **Epam** | Catalog items designed for EPAM workflows |
| **Knowledge & documentation** | Catalog items specialized in creating and managing documentation and knowledge bases |
| **Project management** | Catalog items for project planning, execution, and management |
| **Quality assurance** | Catalog items for test planning, execution, and quality assurance |
| **Other** | Miscellaneous catalog items that do not fit in specific categories |
...
<img src="../img/menus/catalog/catalog_categories.png" width="250" alt="Category filter buttons in Catalog with the active category highlighted." />
...
- **LLM model:** Change which AI model the agent uses. Icons near the model name indicate its supported capabilities:
  ...
  | **Reasoning** | The model uses extended reasoning steps; it exposes **Reasoning Effort** in Model settings instead of **Creativity** |
...
4. Use **Reset to defaults** in the dialog to restore the published agent's original conversation settings.
...
Any modifications you make to a published agent's conversation settings (LLM model, settings, variable values) apply **only to your current conversation**. They do not affect the original published catalog item or how other users experience it. To get a fully editable version, create your own agent or skill in the corresponding menu.
</Warning>
