...
![Intro\_Main\_Interface\_Numbered\_New](../img/menus/overview/menu-navigation.png)
...
11. **Toolkits & Indexes**: Menu, allowing you to create and manage custom toolkits that can be used across different agents and pipelines to extend functionality.
...
15. **Catalog**: Special button located in the bottom section of the sidebar, providing quick access to the centralized shared library for discovering and using community-published agents and skils. Browse by categories, search by keywords, and instantly start conversations with pre-built AI assistants.
