...
15. **Resources**: Special button located in the bottom section of the sidebar, providing access to platform documentation, release notes, video walkthroughs, tutorials, and interactive tours. This menu replaces the previous **Tips** menu.
