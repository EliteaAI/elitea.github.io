...
description: "The Settings is designed to offer you a centralized space to manage vital aspects of your account and configurations. This centralized space is accessible by clicking on the Settings icon in the main navigation sidebar or through your user menu."
---
...
* [**Project Context**](./project-context): Define project-wide background information — domain terminology, workflows, tech stack, and constraints — that the AI automatically uses across all conversations, agents, and pipelines in the project.
