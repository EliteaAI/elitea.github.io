...
description: "The AI Configuration section provides comprehensive management of AI models, embeddings, vector storage, and related integrations within your project environmen"
---
...
<img src="../../img/menus/settings/ai-configurations/access-configurations.gif" alt="AI Configuration" />
---
...
<img src="../../img/menus/settings/ai-configurations/new-llm-model.gif" alt="New LLM" />
...
<img src="../../img/menus/settings/ai-configurations/new-embedding-model.gif" alt="Embedding Model" />
...
<img src="../../img/menus/settings/ai-configurations/new-vector-storage.gif" alt="Vector Storage" />
...
<img src="../../img/menus/settings/ai-configurations/new-image-generation-model.gif" alt="New Image Generation Model" />
...
**Default ASR model ⓘ** The default model used for server-side voice transcription across Chat, Agents, and Pipelines.
...
1. **Ensure Credentials Exist** — Before adding an ASR model, create AI credentials for your provider (see [AI Credentials](#ai-credentials) section)
2. **Click the + Button** — In the Integrations section header, click the **+** button
3. **Select Integration Type** — Choose **Speech Recognition (ASR)** from the list of available integration types
4. **Fill Required Fields:**
...
5. **Click Save** — The ASR model will be created and appear in the Speech Recognition (ASR) section
6. **Set as Default** (Optional) — Use the **Default ASR model** dropdown to make this the default for voice input

    ![New ASR Model](../../img/menus/settings/ai-configurations/new-asr-model.gif)
...
**Default TTS model ⓘ** The default model used for reading AI responses aloud across Chat, Agents, and Pipelines.
...
1. **Ensure Credentials Exist** — Before adding a TTS model, create AI credentials for your provider (see [AI Credentials](#ai-credentials) section)
2. **Click the + Button** — In the Integrations section header, click the **+** button
3. **Select Integration Type** — Choose **Text to Speech (TTS)** from the list of available integration types
4. **Fill Required Fields:**
...
5. **Click Save** — The TTS model will be created and appear in the Text to Speech (TTS) section
6. **Set as Default** (Optional) — Use the **Default TTS model** dropdown to make this the default for voice output

    ![New TTS Model](../../img/menus/settings/ai-configurations/new-tts-model.gif)
...
<img src="../../img/menus/settings/ai-configurations/new-ai-credentials.gif" alt="AI Credentials" />
...
<Accordion title="No Access to LLM Message">
...
<Accordion title="Credential Configuration Not Appearing">
