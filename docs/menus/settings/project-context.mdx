...
1. Select the **Settings** icon in the main navigation sidebar.
2. In **Settings**, select **Project Context**.
...
![Project Context settings page open in ELITEA.](../../img/menus/settings/project-context/project-context-open.png)
...
<video src="../../img/menus/settings/project-context/project-context-create.mp4" controls />
...
<video src="../../img/menus/settings/project-context/project-context-build-ai.mp4" controls />
...
<video src="../../img/menus/settings/project-context/project-context-edit-ai.mp4" controls />
...
<video src="../../img/menus/settings/project-context/project-context-import.mp4" controls />
...
3. Select **Ignore Project Context**.
     ...
     ![Ignore Project Context checkbox in the Advanced section of the agent configuration form.](../../img/menus/settings/project-context/project-context-agent.png)
