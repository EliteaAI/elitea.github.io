...
- **[How to Create and Edit Agents from Canvas](../how-tos/chat-conversations/how-to-create-and-edit-agents-from-canvas)** — Agent configuration including the Ignore Project Context option
</Info>
