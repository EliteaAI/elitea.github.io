...
**Create from Chat:**
 ...
 You can also create and update Project Context directly from chat using the **Project Context Builder** module. When enabled, you can describe your project context in natural language, and the conversation will create or update the Project Background for you. The created context automatically opens in Canvas mode for review. See [Project Context Builder](../../how-tos/modules/project-context-builder) for details.
</Tip>
...
- **[Project Context Builder](../../how-tos/modules/project-context-builder)** — Create and update Project Context directly from chat
