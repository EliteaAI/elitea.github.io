...
**Personal Tokens** allow you to create and manage personal access tokens for API access and IDE integrations. These tokens enable secure communication

To open **Personal Tokens**, in **Settings**, select **Personal Tokens**.

<img src="../../img/menus/settings/personal-tokens/euch_personal-tokens.png" alt="Personal Tokens" />

**Personal Tokens** includes these elements:
...
<img src="../../img/menus/settings/personal-tokens/euch_new-token.png" alt="Generate New Token" />
...
<img src="../../img/menus/settings/personal-tokens/euch_preview-token.png" alt="Preview Token" />
...
2. A `settings.json` file will be downloaded with pre-configured settings including:
   ...
   <img src="../../img/menus/settings/personal-tokens/download-vs-code.png" alt="Download VSCode Settings" />
...
2. An `alita.xml` file will be downloaded with pre-configured settings.
   ...
   <img src="../../img/menus/settings/personal-tokens/download-jetbrains.png" alt="Download JetBrains Settings" />
...
<img src="../../img/menus/settings/personal-tokens/euch_delete-token.png" width="400" alt="Delete Token" />
