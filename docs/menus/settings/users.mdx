---
title: "Users"
description: "The Users section (Settings → Users) allows you to manage user access and roles within a project. This section requires appropriate permissions to view and mana"
---
...
<img src="../../img/menus/settings/users/users-settings-menu.gif" alt="Users Settings Menu" />
...
<img src="../../img/menus/settings/users/users-table.png" alt="Users Table" />
...
<img src="../../img/menus/settings/users/add-users.gif" alt="add users" />

<Info title="Multiple Email Invitations">
You can invite multiple users simultaneously by separating their email addresses with commas.

<img src="../../img/menus/settings/users/add-multiple-users.png" alt="Multiple" width="300" />
</Info>
...
<img src="../../img/menus/settings/users/search-users.gif" alt="Search" />
...
<img src="../../img/menus/settings/users/edit-user-role.gif" alt="Edit User role" />
...
<img src="../../img/menus/settings/users/edit-users-role.gif" alt="Edit Users role" />
...
<img src="../../img/menus/settings/users/delete-user.gif" alt="Deleting User" />
...
<img src="../../img/menus/settings/users/delete-users.gif" alt="Batch Deletion" />

## Best Practices

<Accordion title="Assign Minimum Required Permissions">
...
<Accordion title="Use Role Combinations Strategically">
...
<Accordion title="Invite Users in Batches">
...
<Accordion title="Document Custom Role Assignments">
