...
**Secrets** allows you to securely store and manage sensitive information such as passwords, tokens, API keys, and other authentication credentials.
...
<img src="../../img/menus/settings/secrets/euch_secrets.png" alt="Secrets Settings Menu" />
...
**Secrets** display a table with the following information for each secret:
...
<img src="../../img/menus/settings/secrets/euch_create-secret.png" alt="Create Secret" />
...
<img src="../../img/menus/settings/secrets/euch_edit-secret.png" alt="Edit Secret" />
