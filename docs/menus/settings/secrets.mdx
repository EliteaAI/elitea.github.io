...
<Info title="Secret Name Requirements">
...
<Note title="Create a Secret from the Dropdown">
When the field is switched to **Secret**, the dropdown includes a **Create** section above **Saved Secrets**. From there, you can click **New Project Secret** or **New Private Secret** to open the **Secrets** page in a new browser tab and create a secret immediately. After saving the new secret, return to the credential form and use the **Refresh secrets** button in the dropdown to reload the list.
</Note>
