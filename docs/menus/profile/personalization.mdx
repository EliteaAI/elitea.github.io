...
The *Personalization* in your your user profile includes three main configuration sections:

1. **General**: Allows setting the default AI personality and providing default user instructions
2. **Default Context Management**: Allows managing conversation memory and token usage
3. **Default Summarization**: Allows configuring automatic conversation summarization
...
The *Personalization* page includes four sections:
