...
description: "The Personalization page provides comprehensive settings to customize how the AI assistant interacts with you across all new conversations. This page contains m"
---
...
<Accordion title="Adjust by Use Case">
...
<Accordion title="Consider Conversation Style">
...
<Accordion title="Balance with Token Limits">
...
<Accordion title="Testing Recommendations">
...
<Accordion title="Align with Primary Use Case">
...
<Accordion title="Consider Team Communication Style">
...
<Accordion title="Personality Can Be Overridden">
...
<Accordion title="Structure Instructions Logically">
...
<Accordion title="Settings Not Applying to New Conversations">
**Symptoms:**
...
<Accordion title="Numeric Fields Not Saving (Silent Failure)">
**Symptoms:**
...
<Accordion title="AI Not Following Default Instructions">
**Symptoms:**
...
<Accordion title="Personality Selection Not Visible in Responses">
**Symptoms:**
...
<Accordion title="Failed to Save Settings Error Appears">
**Symptoms:**
