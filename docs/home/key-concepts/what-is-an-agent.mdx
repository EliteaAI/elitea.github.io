...
description: "An agent is a virtual assistant that automates tasks and streamlines workflows. Unlike simple automation, agents can make decisions, adapt to changing condition"
---
...
Ready to get started? Explore the [Agents menu](../../menus/agents) to create your first digital teammate.
