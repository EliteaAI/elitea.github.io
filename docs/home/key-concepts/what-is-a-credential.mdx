...
description: "A credential is a secure storage mechanism that holds authentication information needed to connect agents to external services and systems. Think of credentials"
---
...
Ready to manage your credentials? Check out the [Credentials menu](../../menus/credentials) to create and manage your service connections.
