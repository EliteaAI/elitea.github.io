---
title: "Pipeline Nodes Overview"
description: "Nodes are the fundamental building blocks of ELITEA Pipelines—individual steps that perform specific actions within your workflow. Each node:"
---
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/node-diagram.png" alt="Node Concept Diagram" />
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/node-attributes.png" alt="Common Node Attributes" />
...
1. **[LLM Node](./interaction-nodes#llm-node)** - Interact with Large Language Models
     * Call AI models (GPT-4, Claude, etc.) for text generation
     * Support chat history and conversation context
     * Bind tools for function calling
     * Extract structured data from responses

2. **[Agent Node](./interaction-nodes#agent-node)** - Delegate tasks to pre-built AI agents
...
1. **[Toolkit Node](./execution-nodes#toolkit-node)** - Execute ELITEA toolkit functions
...
2. **[MCP Node](./execution-nodes#mcp-node)** - Execute Model Context Protocol (MCP) tools
...
3. **[Code Node](./execution-nodes#code-node)** - Run custom Python code
...
1. **[Router Node](./control-flow-nodes#router-node)** - Route based on expression evaluation
      * Evaluate Python expressions
      * Direct flow to specific nodes based on result
      * Support multiple output routes
      * Use state variables in conditions

2. **[Decision Node](./control-flow-nodes#decision-node)** - AI-powered routing decisions
...
3. **[Human-in-the-Loop Node](./control-flow-nodes#human-in-the-loop-node)** - Pause for a human decision
...
1. **[State Modifier Node](./utility-nodes#state-modifier-node)** - Transform and clean state
...
2. **[Printer Node](./utility-nodes#printer-node)** - Display formatted output to users
...
**Migration Guide:** [Condition Node Migration](../../../migration/v2.0.1/condition-node-migration)
</Accordion>
...
**Migration Guide:** [Loop Node Migration](../../../migration/v2.0.1/loop-node-migration)
</Accordion>

<Accordion title="Loop from Tool Node">
...
<Accordion title="Pipeline (Subgraph) Node">
...
**Migration Guide:** [Pipeline Node Migration](../../../migration/v2.0.1/pipeline-node-migration)
</Accordion>

---

<Info title="Related Documentation">
- **[States](../states)** - Understand how nodes read from and write to pipeline state
- **[Connections](../nodes-connectors)** - Learn how to link nodes together
- **[Entry Point](../entry-point)** - Define where your pipeline begins
- **[Flow Editor](../flow-editor)** - Build pipelines visually with drag-and-drop
- **[YAML Configuration](../yaml)** - See complete node definition syntax
- **[Appendix - Comparison Tables](../appendix-comparison-tables)**
</Info>