---
title: "Appendix: Comparison Tables"
description: "Quick reference for selecting pipeline components."
---

<Tip title="Quick Navigation">
...
|------|----------|---------|-----|---------------|-------------|
| **[LLM](./nodes/interaction-nodes#llm-node)** | Interaction | Generate/analyze text | ✔️ | ✘ | Structured output, tool calling |
| **[Agent](./nodes/interaction-nodes#agent-node)** | Interaction | Specialized agents | ✔️ | ✘ | Reusable configurations |
| **[Toolkit](./nodes/execution-nodes#toolkit-node)** | Execution | Direct ELITEA toolkit call | ✘ | ✔️ | Explicit parameters, fast |
| **[MCP](./nodes/execution-nodes#mcp-node)** | Execution | Model Context Protocol tools | ✘ | ✔️ | Remote MCP servers |
| **[Code](./nodes/execution-nodes#code-node)** | Execution | Python logic | ✘ | ✘ | Full programming control |
| **[Custom](./nodes/execution-nodes#custom-node)** | Execution | Advanced config | Varies | Varies | Maximum flexibility |
| **[Router](./nodes/control-flow-nodes#router-node)** | Control Flow | Template routing | ✘ | ✘ | Multiple paths |
| **[Decision](./nodes/control-flow-nodes#decision-node)** | Control Flow | AI routing | ✔️ | ✘ | LLM decision making |
| **[HITL](./nodes/control-flow-nodes#human-in-the-loop-node)** | Control Flow | Human approval checkpoint | ✘ | ✘ | Approve / Edit / Reject actions |
| **[State Modifier](./nodes/utility-nodes#state-modifier-node)** | Utility | Transform state | ✘ | ✘ | Jinja2 templates |
| **[Printer](./nodes/utility-nodes#printer-node)** | Utility | Display output to users | ✘ | ✘ | Pause & show messages |
...
* [Pipelines Overview](./overview) · [States](./states) · [Nodes Overview](./nodes/overview)
* [Interaction Nodes](./nodes/interaction-nodes) · [Execution Nodes](./nodes/execution-nodes)
* [Control Flow Nodes](./nodes/control-flow-nodes) · [Utility Nodes](./nodes/utility-nodes)
* [Entry Point](./entry-point) · [Nodes Connectors](./nodes-connectors) · [Flow Editor](./flow-editor) · [YAML Configuration](./yaml)
