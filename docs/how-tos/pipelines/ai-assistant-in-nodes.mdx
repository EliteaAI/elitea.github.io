---
title: "AI Assistant in Pipeline Nodes"
description: "The AI Assistant feature enhances pipeline node configuration by providing intelligent, AI-powered content generation for text fields. It helps you create, refi"
---
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/ai-assistant/ai-assistant-access.gif" alt="AI Assistant Icon" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/ai-assistant/single-view-mode.png" alt="AI Assistant Icon" width="350" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/ai-assistant/split-view-mode.png" alt="AI Assistant Icon" width="350" />
...
<Info title="Generate System Prompt Example">
...
<Info title="Generate Tiered Discount Code">
...
<Info title="Generate User Story Template">
...
<Info title="Generate Router Condition">
...
<Info title="Generate Decision Description">
...
<Info title="Generate F-String Review Message">
...
<Info title="Generate Processing Summary (Type: F-String)">
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/ai-assistant/genarate-llm-prompt.gif" alt="Genarate" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/ai-assistant/improve-llm-prompt.gif" alt="Improve" />
...
<Accordion title="Generate System Prompts for Specialized Agents">
...
<Accordion title="Build Complex Routing Logic">
...
<Accordion title="Create Data Transformation Code">
...
<Accordion title="Format Output Templates">
...
<Accordion title="Craft HITL User Messages">
...
<Accordion title="AI Assistant Not Appearing">
...
<Accordion title="Generated Content Not Applied">
...
<Accordion title="Generation Fails with Error">
...
<Accordion title="Split View Not Showing">
...
* **[LLM Node](./nodes/interaction-nodes#llm-node)** - Configure LLM nodes with AI Assistant
* **[Code Node](./nodes/execution-nodes#code-node)** - Write Python code with AI help
* **[State Modifier Node](./nodes/utility-nodes#state-modifier-node)** - Create Jinja templates
* **[Router Node](./nodes/control-flow-nodes#router-node)** - Build routing conditions
* **[Decision Node](./nodes/control-flow-nodes#decision-node)** - Write decision descriptions
* **[HITL Node](./nodes/control-flow-nodes#human-in-the-loop-node)** - Create user interrupt messages
* **[Pipeline Configuration](./overview)** - Configure pipeline LLM settings
* **[States](./states)** - Understanding pipeline state for AI-generated code
</Info>
