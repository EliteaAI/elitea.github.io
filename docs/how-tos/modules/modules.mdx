...
<CardGroup cols={2}>
  ...
  <Card title="Agents & Pipeline Builder" icon="sitemap" href="../chat-conversations/agents-&-pipeline-builder">
...
| **Agents & Pipeline Builder** | <ul><li>MCP features must be enabled on the platform.</li><li>Agents must carry the **`mcp`** tag to be callable as tools.</li></ul> |
...
| Combination | Why |
|-------------|-----|
| **Ask User** + **Skill Builder**, **Project Context Builder**, or **Agents & Pipeline Builder** | Builders can pause and ask clarifying questions instead of guessing at missing details or requesting them through plain chat responses. |
