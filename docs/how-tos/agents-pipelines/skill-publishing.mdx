...
The following table lists the fields and actions on this step.
...
The following card summarizes the publishing terms.
...
Use the following tabs to review the validation outcomes.

<Tabs>
  <Tab title="Passed">
    The following table lists the validation statuses that let you continue.
  ...
  <Tab title="Not Passed">
    The following table lists the validation status that blocks publishing.
...
<AccordionGroup>
  ...
  <Accordion title="Issue: Validation fails with a transient AI error on every attempt">
  ...
  <Accordion title="Issue: Publishing fails because the validation token is invalid or expired">
  ...
  <Accordion title="Issue: Publishing fails with a duplicate version name error">
  ...
  <Accordion title="Issue: Unpublish fails because the version is not published">
...
- [Agents](../../menus/agents) — Related publishing flow for agents
