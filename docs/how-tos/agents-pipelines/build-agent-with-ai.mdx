...
From the **Configuration** tab, continue configuring the agent — adjust the LLM model, add more toolkits, set variables, configure internal tools, and save or publish.
