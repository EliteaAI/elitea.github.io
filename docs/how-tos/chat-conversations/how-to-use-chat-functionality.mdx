...
<img src="../../img/menus/chat/create-folder.png" alt="Create Folder" />

### Creating a New Chat from a Folder

You can create a new chat directly inside a folder. this will save your time moving conversations to the necessary folders after their creation.
...
3. Enter your first message to create the chat inside the folder.
...
* **Rename**: Rename the conversation. Enter the new name and confirm.
...
* **Pin/Unpin**: Select **Pin on top** to keep the conversation at the top of the list for easy access. Select **Unpin** on a pinned conversation to remove it from the top.
...
<CardGroup cols={3}>
  ...
  <Card title="Users" icon="user">
    In public chats, other project members who join or interact become participants.
  </Card>
</CardGroup>
