...
In the **TOOLS** section, enhance your agent's capabilities by adding integrations and enabling internal tools.
...
<CardGroup cols={3}>
  ...
  <Card title="Elitea MCP Tools" icon="plug" href="./elitea-mcp-tools-internal-tool">
    Expose ELITEA's own capabilities as MCP tools, allowing agents to interact with projects, prompts, datasources, and more.
  </Card>
</CardGroup>
