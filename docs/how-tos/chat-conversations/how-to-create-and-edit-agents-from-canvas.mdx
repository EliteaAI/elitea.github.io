...
<Steps>
  ...
  <Step title="Configure Agent">
    ...
    **INSTRUCTIONS**
    ...
    - **Mentions**: Type `/` to open a suggestion dropdown listing all configured toolkits, MCPs, agents, and pipelines. For toolkits and MCPs, you can optionally select a specific tool to produce a `/Name/ToolName` mention. Inserted mentions are highlighted in the field.
    </Tip>
