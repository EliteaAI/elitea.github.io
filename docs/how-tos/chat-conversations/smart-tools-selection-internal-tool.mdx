...
description: "Reduce token usage in chats and agents by loading toolkit schemas and tools on demand."
---
...
<Tip title="When to Use Smart Tools Selection">
...
Enable Smart Tools Selection for token-optimized chats.

1. Go to your chat.
2. In the chat toolbar, select **+**.
3. Select **Modules** → **Smart Tools Selection** in the list.
5. Toggle **Smart Tools Selection** on to enable it.

<img src="../../img/how-tos/chat-conversations/internal-tools/smart-tools-selection/euch_sts_on_chat.png" alt="Enable Smart Tools Selection in chat"/>
...
5. Find **Smart Tools Selection**. If it is not immediately visible, select **Show all** to see the full list of modules.
6. Toggle **Smart Tools Selection** on.
7. Select **Save**.

     <img src="../../img/how-tos/chat-conversations/internal-tools/smart-tools-selection/euch_sts-for-agent.png" alt="Enable Smart Tools Selection for agents" width="400" />

<Tip title="Recommended for Multi-Toolkit Agents">
...
## How to Use Smart Tools Selection
...
<Check title="When Smart Tools Selection Excels">
...
<Accordion title="Enable for agents with 5+ toolkits">
...
<Accordion title="Modules are not visible in the chat toolbar">
**Possible causes:**

* No module has passed the availability filter for the current project
* Image Generation is the only tool configured, but its required provider toolkit is not set up

**Solution:**

1. Modules are hidden entirely when no tools are available for the project
...
<Info title="Compatibility with Other Modules">
Smart Tools Selection works seamlessly with other moduless. Middleware tools like **Planning**, **Python Sandbox**, **Data Analysis**, **Swarm Mode**, and **Image Generation** are always bound directly (not through meta-tools) for immediate availability and optimal performance.
</Info>
...
* **[Python Sandbox](./python-sandbox-internal-tool)** - Python Sandbox overview and usage
* **[Data Analysis](./data-analysis-internal-tool)** - Data Analysis tool
* **[Image Generation](./image-generation)** - Generate images in conversations
* **[Attachments in Conversations](./attach-files)** - Upload and attach files for AI analysis
