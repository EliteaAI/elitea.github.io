...
description: "Create, prioritize, and track tasks directly within chats using the Planner."
---
...
Enable the Planner tool for ad-hoc task management in chats.

1. Go to your chat.
2. In the chat toolbar, select **+**.
3. Select **Modules** → **Planner** in the list.
5. Toggle **Planner** on to enable it.
...
Modules configuration persists for the duration of your chat session. You can toggle the Planner on/off at any time.
</Tip>
...
5. Find **Planner**. If it is not immediately visible, select **Show all** to see the full list of modules.
6. Toggle **Planner** on.
7. Select **Save**.

     <img src="../../img/how-tos/chat-conversations/internal-tools/planner/euch_planner-for-agent.png" alt="Enable planner for agents" width="400" />

<Info title="Agent vs Chat Settings">
- **Agent Configuration**: Sets the default state for all new chats with that agent
- **Chat Configuration**: Overrides the agent's default for that specific conversation
...
<Info title="Conversations and Agents">
...
<img src="../../img/how-tos/chat-conversations/internal-tools/planner/planner-create-plan.gif" alt="Agent Planner Configuration" width="700" />
...
<Accordion title="Follow-Up Reminders">
...
<Accordion title="Include Due Dates for Time-Sensitive Tasks">
**Examples:**
...
<Accordion title="Use Planner for Multi-Step Processes">
**Good use cases:**
...
<Accordion title="Link Related Tasks in Conversation">
...
<Accordion title="Clean Up Completed Tasks">
...
<Accordion title="Issue: Planner Not Responding to Task Commands">
**Possible causes:**
...
1. Verify Planner toggle is ON in **Modules**
...
<Accordion title="Issue: Tasks Not Persisting">
**Possible causes:**
...
<Accordion title="Issue: Cannot Enable Planner in Agent">
**Possible causes:**
...
<Accordion title="Issue: Planner Creates Wrong Task Details">
**Possible causes:**
...
<Accordion title="Issue: Modules configuration updated But Planner Still Not Working">
**Possible causes:**
...
<Accordion title="Issue: Tasks Appear in Wrong Format">
**Possible causes:**
...
* **[Agent Configuration](../../menus/agents)** - Setting up agents with modules and tools
