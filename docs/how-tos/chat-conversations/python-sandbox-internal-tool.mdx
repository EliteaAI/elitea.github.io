...
description: "Run secure Python code in conversations with persistent session state and Pyodide-compatible libraries."
---
...
<Tip title="When to Use Python Sandbox">
...
<Info title="What the Assistant Can Do">
...
Enable Python Sandbox for code execution in your chats.

1. Go to your chat.
2. In the chat toolbar, select **+**.
3. Select **Modules** → **Python sandbox** in the list.
5. Toggle **Python sandbox** on to enable it.

<img src="../../img/how-tos/chat-conversations/internal-tools/python-sandbox/euch_python_on_chat.png" alt="Enable Python sandbox in chat"/>

<Info title="Configuration Persistence">
The Python Sandbox setting persists for the duration of your chat session. You can toggle it on/off at any time.
</Info>
...
5. Find **Python sandbox**. If it is not immediately visible, select **Show all** to see the full list of modules.
6. Toggle **Python sandbox** on.
7. Select **Save**.

     <img src="../../img/how-tos/chat-conversations/internal-tools/python-sandbox/euch_python-for-agent.png" alt="Enable Python sandbox for agents" width="400" />

<Tip title="Recommended for Data & Development Agents">
...
<Accordion title="Use Python Sandbox for Prototyping and Testing">
...
When working with conversation attachments (CSV, Excel files), enable both Python Sandbox and Data Analysis modules. Python Sandbox provides the execution environment, while Data Analysis can help with file parsing and data structure handling.
</Accordion>
...
<Check title="When Python Sandbox Excels">
...
<Warning title="When to Consider Alternatives">
...
<Accordion title="Python Sandbox Not Executing Code">
**Possible Causes:**
...
<Accordion title="Code Execution Timeout">
**Possible Causes:**
...
<Accordion title="Stateful Session Not Preserving Variables">
**Possible Causes:**
...
- [Data Analysis](./data-analysis-internal-tool) - Complementary tool for working with uploaded CSV/Excel files
- [Swarm Mode](./swarm-mode-internal-tool) - Multi-agent collaboration for complex workflows
- [Smart Tools Selection](./smart-tools-selection-internal-tool) - Intelligent toolkit selection and management
- [Planner](./planner-internal-tool) - Task planning and execution coordination
- [Agent Configuration](../../menus/agents) - Complete guide to configuring agents and toolkits
- [Conversation Management](../../menus/chat) - Managing conversations and settings
- [Toolkits Overview](../../menus/toolkits) - Understanding toolkits and tools
</Info>
