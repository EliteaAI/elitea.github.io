---
title: "Edit Files in Canvas"
sidebarTitle: "Edit Files in Canvas"
description: "Open, edit, and save attached, stored, and generated files directly in Canvas, including code, documents, and data files."
---
...
<Info title="Scope of This Guide">
This guide focuses on editing **complete files** (attachments, artifacts, and AI-generated files). For information about editing generated code blocks, tables, or diagrams within chat conversations, see [Canvas in Conversation](./how-to-canvas).
</Info>
...
3. **Edit the File:** Canvas automatically selects the appropriate editor based on file type. Make your changes using the available editing features, including universal controls like Copy, Undo/Redo, and Export/Download.
    ...
    !!! info "Available Editors"
        ...
        - **DOCX Editor**: WYSIWYG editor with formatting toolbar, ruler, and zoom control for Word documents (.docx). See [The DOCX Editor](./how-to-canvas#the-docx-editor) for a full walkthrough.
...
<Info title="Single-User Editing & Permissions">
...
<Info title="Example 1: Editing an Attached Configuration File from Chat">
...
<Info title="Example 2: Editing Test Data from Artifacts">
...
<Warning title="Editing Limitations">
...
<Accordion title="Issue: Eye Icon Not Appearing on Attached Files">
**Possible causes:**
...
<Accordion title="Issue: View/Edit file Icon Not Available for Attachments">
**Possible causes:**
...
<Accordion title="Issue: Cannot Save Changes in Artifacts">
**Possible causes:**
...
<Accordion title="Issue: File Preview Shows Error">
**Possible causes:**
...
<img src="../../img/how-tos/chat-conversations/edit-file-in-canvas/error-file-size.png" alt="Artifacts" width="600" />
...
<Accordion title="Issue: Canvas Editor is Slow or Unresponsive">
**Possible causes:**
...
<Accordion title="Issue: Changes Not Appearing After Save">
**Possible causes:**
...
<Accordion title="Issue: Unsaved Changes Alert Keeps Appearing">
**Possible causes:**
...
- **[Canvas in Conversation](./how-to-canvas):** Guide on using Canvas for editing generated code blocks, tables, and diagrams within conversations
- **[Chat Usage Guide](./how-to-use-chat-functionality):** Complete overview of chat functionality including file attachments
- **[Artifacts Menu](../../menus/artifacts):** Full documentation on Artifacts management and file organization
- **[Attachments in Conversations](./attach-files):** Upload and attach images, documents, and data files for AI analysis
</Info>
