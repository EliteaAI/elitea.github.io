...
description: "Monitor token usage and manage context budgets with pruning and summarization across conversations and runs."
---
...
Context management is **enabled by default** for all projects — no configuration is required to start using it. The Context Budget widget appears automatically once an active conversation exists.
...
5. View pruning and summarization activity in real-time
     ...
     <img src="../../img/how-tos/chat-conversations/context-management/agent-context-budget.gif" alt="Chat Context Budget" width="600" />
...
6. Observe automatic context management as the pipeline runs
     ...
     <img src="../../img/how-tos/chat-conversations/context-management/pipeline-context-budget.gif" alt="Pipelinet" width="600" />
---
...
* The minimal view shows essential token usage at a glance:
    ...
    <img src="../../img/how-tos/chat-conversations/context-management/collapsed-view.png" alt="Collapsed View" width="160" />
...
* **Edit Button**: Click to open the full Context Management configuration modal
    ...
    **Conversation**
       ...
       <img src="../../img/how-tos/chat-conversations/context-management/compact-view.png" alt="Compact View" width="250" />

    **Agents** and **Pipelines**

       <img src="../../img/how-tos/chat-conversations/context-management/compact-view-agent.png" alt="Compact View" width="250" />
---
...
* **User Instructions**: Manage system message preservation, default persona, and custom user instructions
     ...
     <img src="../../img/how-tos/chat-conversations/context-management/expanded-view.png" alt="Expanded View" width="300" />
...
* At the top of the expanded view, there is a toggle switch to enable or disable Context Management entirely. When disabled, all automatic context management features (pruning and summarization) are turned off.
     ...
     <img src="../../img/how-tos/chat-conversations/context-management/context-managment-off.png" alt="Context Management Toggle" width="300" />
...
<Warning title="Token Limit Mid-Response">
...
<img src="../../img/how-tos/chat-conversations/context-management/token-limit-message.png" alt="Token Limit" width="700" />
</Warning>
...
* The expanded view displays three real-time usage metrics:
    ...
    <img src="../../img/how-tos/chat-conversations/context-management/overview-metrics.png" alt="Metrics" width="580" />
...
* Configure token limits and message preservation to control how context is managed:
    ...
    <img src="../../img/how-tos/chat-conversations/context-management/context-strategy.png" alt="Context Strategy" width="500" />
...
* Configure automatic summarization to compress older messages and preserve conversation continuity:
    ...
    <img src="../../img/how-tos/chat-conversations/context-management/summarization.png" alt="Summarization" width="400" />
...
* Configure system message preservation, default persona, and custom instructions for the assistant:
    ...
    <img src="../../img/how-tos/chat-conversations/context-management/user-instruction.png" alt="User Instructions" width="450" />
...
<Accordion title="Long-Running Conversations">
...
<Accordion title="Multi-Turn Agent Tasks">
...
<Accordion title="Pipeline Chat Contexts">
...
<Accordion title="Regular Budget Checks">
...
<Accordion title="Understanding Token Consumption">
...
<Accordion title="Message Structure">
...
<Accordion title="Preserve Recent Messages Setting">
...
<Accordion title="Coordinating Target Summary Tokens with Max Context Tokens">
...
<Accordion title="Context Budget Widget Not Visible">
**Symptoms:**
...
1. Confirm you're viewing a supported interface (Chat, Agent, Pipeline)
2. Send at least one message — the widget only appears after the first message initiates a conversation
3. Check browser console for errors

**Resolution:**

1. Ensure you have sent at least one message to start the conversation
2. Refresh the page and try again
3. If the issue persists, contact your administrator to check backend service health
</Accordion>

<Accordion title="Token Count Seems Inaccurate">
**Symptoms:**
...
<Accordion title="Summarization Not Occurring">
**Symptoms:**
...
<Accordion title="Messages Disappearing Unexpectedly">
**Symptoms:**
...
<Accordion title="Settings Not Saving — Inline Validation Error">
**Symptoms:**
...
<Accordion title="Settings Not Saving — Toast Error After Submit">
**Symptoms:**
...
If you encounter issues not covered in this guide or need additional assistance with context management, please refer to **[Contact Support](../../support/contact-support)** for detailed information on how to reach the ELITEA Support Team.

---

<Info title="Related Documentation">
* **[Chat Functionality](./how-to-use-chat-functionality)** - General chat features and usage
* **[Agent Configuration](../../menus/agents)** - Setting up agents with context management
* **[Pipeline Configuration](../../menus/pipelines)** - Configuring pipelines with context support
</Info>
