...
### Edit the Last Message with Attachments

When you edit your last chat message, existing attachments remain visible and are not lost automatically.

**While editing the last message, you can:**

- Keep the existing attached files as they are
- Remove any existing attachment if you no longer want to send it
- Add a new attachment using the **attach** icon on the left side of the editor

<Info title="Editing Preserves Attachments">
Entering message edit mode does not remove previously attached files. Existing attachments stay visible until you explicitly remove them.
</Info>
