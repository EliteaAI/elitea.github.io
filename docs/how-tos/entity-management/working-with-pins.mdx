---
title: "Working with PINs"
sidebarTitle: "Use PINs"
description: "PINs replace the deprecated Collections feature. Pinned entities remain at the top of their respective lists across sessions, making it easy to access your most"
---

<Warning title="Migration from Collections">
If you previously used **Collections**, they have been removed. Use PINs instead — pinned items stay at the top of each list across sessions.
</Warning>
...
<Info title="Detail View Pin Icon Location">
...
<Tabs>
  <Tab title="Card View">
    ...
    <img src="../../img/how-tos/entity-management/pins/pin-card-view.gif" alt="Card" width="600" />
  </Tab>
  <Tab title="Table View">
    ...
    <img src="../../img/how-tos/entity-management/pins/pin-table-view.gif" alt="Table" width="600" />
  </Tab>
  <Tab title="Detail View">
    ...
    <img src="../../img/how-tos/entity-management/pins/pin-detail-view.gif" alt="Detail" width="600" />
  </Tab>
</Tabs>
**Unpinning Entities**
...
<Warning title="Collections Menu Deprecated">
...
<Accordion title="How many entities can I pin?">
...
<Accordion title="What happens when I pin a newly created entity?">
...
<Accordion title="Can I reorder my pinned items?">
...
<Accordion title="What's the difference between pinning in card view vs. table view?">
...
<Accordion title="What happened to the 'Add to collection' feature?">
