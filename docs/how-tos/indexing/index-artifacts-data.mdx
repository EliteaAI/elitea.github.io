...
<Info title="Bucket Management">
For detailed instructions on managing Artifact buckets and files, see:

- [ELITEA Artifacts Menu](../../menus/artifacts)
- [Artifact Toolkit Guide](../../integrations/toolkits/artifact_toolkit)
</Info>
...
- [Artifact Toolkit Integration Guide](../../integrations/toolkits/artifact_toolkit)
</Info>
...
<Info title="Alternative Indexing Method">
...
<Info title="Chunking Configuration">
...
- **[ELITEA Artifacts Menu](../../menus/artifacts)** - *Learn how to manage Artifact buckets and files*
- **[Artifact Toolkit Guide](../../integrations/toolkits/artifact_toolkit)** - *Comprehensive guide to the Artifact Toolkit and its capabilities*
