...
1. Open the toolkit detail page to view the **Indexes** section in the right panel.
2. Select an existing index card to open its dedicated index page.
...
- The **Indexes** section appears in the right panel.
- Select the **docs** index card.
