...
<Warning title="Availability and migration">
...
<Info title="Replacement for datasets">
 These tools replace legacy datasets. Your old datasources remain visible for reference in Nexus, but you should use the new tools in Next env to re-create indexes. For detailed migration guidance, see [Migrate Datasources to Indexing](../../migration/v1.7.0/migrate-datasources-to-indexing).
</Info>
...
1) Configure Credentials (required for all except Artifact)
   ...
   * See: [Create a Credential](../../getting-started/create-credential) and specific toolkit pages under Integrations → Toolkits.
...
<img src="../../img/how-tos/indexing/toolkit-config.gif" alt="Toolkit" />

<Info title="Helpful links">
* Create a Credential: [Guide](../../getting-started/create-credential)
* Create a Toolkit: [Guide](../chat-conversations/how-to-create-and-edit-toolkits-from-canvas)
* Examples: [GitHub](./index-github-data), [Confluence](./index-confluence-data), [Jira](./index-jira-data), [SharePoint](./index-sharepoint-data)
</Info>
...
6. Monitor progress with visual indicators:
     ...
     - ⚠️ **Partially Indexed**: Indexing finished but some files were skipped (unsupported extension, empty content, filter match, or read error). The index is fully usable for search and scheduling.
...
See the [How to create and use indexes](./using-indexes-tab-interface) guide for detailed instructions.


<img src="../../img/how-tos/indexing/index-tab/start-indexing.gif" alt="Creating New Index" />
...
<img src="../../img/how-tos/indexing/index-test-settings.gif" alt="Toolkit Test – Index Data" width="900" />
...
- **Status Icon**: Real-time visual indicator (In Progress, Completed, Partially Indexed, Failed, Stopped)
...
<img src="../../img/how-tos/indexing/index-tab/index-card.png" alt="Index Card in Sidebar" width="200" />

<Tip title="Index Management Features">
- **Manual Reindexing**: Click **Reindex** button in Configuration tab to update index with original settings
- **Automated Scheduling**: Toggle **Schedule** switch to enable cron-based reindexing (available for **Completed** and **Partially Indexed** indexes)
...
<img src="../../img/how-tos/indexing/list-collection.gif" alt="Toolkit Test – List Collections output" width="900" />
...
<img src="../../img/how-tos/indexing/index-tab/reindex.gif" alt="Manual Reindex" />
...
1. Select a **Completed** or **Partially Indexed** index from the sidebar (scheduling is available for both statuses)
...
<img src="../../img/how-tos/indexing/schedule-indexing/configure-cron-expression.gif" alt="Configure Cron Expression" />

<Tip title="Detailed Scheduling Guide">
For comprehensive information about scheduling features, cron expressions, troubleshooting, and best practices, see the [Schedule Indexing](./schedule-indexing) guide.
</Tip>
...
<img src="../../img/how-tos/indexing/index-tab/delete-index.gif" alt="Delete Index" />
...
1. Navigate to **Toolkits** → Select your toolkit → Click **Indexes** tab
2. Select a **Completed** or **Partially Indexed** index from the sidebar
...
<img src="../../img/how-tos/indexing/index-tab/stepback-summary-index.gif" alt="Stepback Summary Index Search" />

<Info title="Search Prerequisites">
- Indexes with **Completed** or **Partially Indexed** status support search operations. Failed and stopped indexes do not.
...
2. Click the **History** tab in the center panel (only available for **Completed** and **Partially Indexed** indexes)
...
1. Open Chat and start a new conversation or use an existing one. See [Chat](../../menus/chat).
...
<img src="../../img/how-tos/indexing/indexing-from-chat.gif" alt="Chat – trigger indexing" width="900" />
...
5. Are there usage limits?
	* Next uses shared LLMs for evaluation and may have daily limits. For production, configure your own EPAM AI DIAL keys in Settings → [AI Configuration](../../menus/settings/ai-configuration) and see [Configure EPAM AI DIAL Key](../../getting-started/configure-epam-ai-dial-key).

<Check title="Next steps">

	* **Start with the Indexes Tab**: Use the [How to create and use indexes](./using-indexes-tab-interface) guide to create your first index via the dedicated interface.
