...
1. **TestRail Credential**: A TestRail API key with [authentication credentials](../credentials-toolkits/how-to-use-credentials#testrail-credential-setup) configured in ELITEA
...
- [TestRail Credential Setup](../credentials-toolkits/how-to-use-credentials#testrail-credential-setup)
- [TestRail Toolkit Integration Guide](../../integrations/toolkits/testrail_toolkit)
</Info>
...
<Info title="TestRail URL Format">
...
<Info title="Alternative: Test Settings Method">
...
- **[Indexing Overview](./indexing-overview)** - *Complete guide to ELITEA's indexing system and capabilities*
- **[Indexing Tools](./indexing-tools)** - *Detailed reference for all indexing tools and parameters*
- **[TestRail Toolkit Guide](../../integrations/toolkits/testrail_toolkit)** - *Comprehensive guide to the TestRail Toolkit and its capabilities*
- **[How to Use Credentials](../credentials-toolkits/how-to-use-credentials#testrail-credential-setup)** - *TestRail credential setup and management*    
- **[AI Configuration](../../menus/settings/ai-configuration)** - *Set up vector storage and embedding models for indexing*
- **[Toolkits Menu](../../menus/toolkits)** - *General toolkit configuration and management*
- **[Chat Menu](../../menus/chat)** - *Create conversations and add toolkits as participants*
- **[Agents Menu](../../menus/agents)** - *Create AI agents with access to your indexed TestRail data*
</Info>
