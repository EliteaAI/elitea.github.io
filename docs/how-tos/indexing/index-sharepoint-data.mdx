---
title: "Index SharePoint Data"
description: "Indexing tools are available in the Next environment (Release 1.7.0) and replace legacy Datasources/Datasets. For context, see Release Notes 1.7.0 and the Index"
---

<Warning title="Availability">
Indexing tools are available in the [Next environment](https://next.elitea.ai) (Release 1.7.0) and replace legacy Datasources/Datasets. For context, see [Release Notes 1.7.0](../../release-notes/archived/rn13#indexing-dedicated-toolkit-indexes-tab) and the [Indexing Overview](./indexing-overview).
</Warning>

<Info title="Migration from Datasources">
...
1. **SharePoint Credential**: An Azure AD app registration with [authentication credentials](../credentials-toolkits/how-to-use-credentials#sharepoint-credential-setup) configured in ELITEA
2. **Vector Storage**: PgVector selected in Settings → [AI Configuration](../../menus/settings/ai-configuration)
3. **Embedding Model**: Selected in AI Configuration (defaults available) → [AI Configuration](../../menus/settings/ai-configuration)
...
- [SharePoint Toolkit Integration Guide](../../integrations/toolkits/sharepoint_toolkit#step-1-create-sharepoint-credentials)
</Info>
...
- [Toolkits Menu](../../menus/toolkits)
- [SharePoint Toolkit Integration Guide](../../integrations/toolkits/sharepoint_toolkit#step-2-create-sharepoint-toolkit)
</Info>
...
<Info title="onenote_filter structure">
...
2. Monitor real-time status via the indicator on the index list item and detail header:
      ...
      |--------|-----------|-------------|
      | **In Progress** | ![in progress](../../img/how-tos/indexing/sharepoint/in-progress-badge.png)| Indexing is currently running |
      ...
      | **Failed** |![in progress](../../img/how-tos/indexing/sharepoint/error-badge.png)| Indexing encountered a fatal error |
      | **Stopped** | ![in progress](../../img/how-tos/indexing/sharepoint/stopped-badge.png) | Indexing was manually cancelled |
...
<Info title="Detailed Instructions">
For a complete walkthrough of the scheduling feature, see [Schedule Indexing](./schedule-indexing).
</Info>
...
<Info title="Index the Document Library">
**User:**
...
<Info title="Verify Index Creation">
**User:**
> "List my collections"
...
<Info title="Search Indexed Content">
...
<Accordion title="Indexes Tab Not Visible or Tab Disabled">
...
<Accordion title="Authentication Failed or Unauthorized Access">
...
<Accordion title="Site Not Found or Access Denied to Site">
...
<Accordion title="No Files Indexed or Empty Document Library">
...
<Accordion title="Index Name Validation Error (Exceeds 7 Characters)">
...
<Accordion title="File Processing Errors or Document Parsing Failures">
...
<Accordion title="OneNote Indexing Fails with 401 Unauthorized (include_onenote: true enabled)">
...
<Accordion title="Large SharePoint Sites">
...
<Accordion title="Search Returns Few or No Results">
...
<Accordion title="Improving Search Quality">
...
- [Create a Credential](../../getting-started/create-credential) - Step-by-step credential creation guide
- [How to Use Credentials](../credentials-toolkits/how-to-use-credentials) - Credential management and SharePoint setup
- [Toolkits Menu](../../menus/toolkits) - Toolkit configuration and management
- [SharePoint Toolkit Integration Guide](../../integrations/toolkits/sharepoint_toolkit) - Complete SharePoint toolkit reference
- [AI Configuration](../../menus/settings/ai-configuration) - Vector storage and embedding model setup
