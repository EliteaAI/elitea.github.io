...
1. **Jira Credential**: A Jira API token or [authentication credentials](../credentials-toolkits/how-to-use-credentials#jira-credential-setup) configured in ELITEA
...
- [Jira Credential Setup](../credentials-toolkits/how-to-use-credentials#jira-credential-setup)
</Info>
...
- [Jira Toolkit Integration Guide](../../integrations/toolkits/jira_toolkit)
</Info>
...
- [How to Use Credentials](../credentials-toolkits/how-to-use-credentials) - Credential management and Jira setup
- [Toolkits Menu](../../menus/toolkits) - Toolkit configuration and management
- [Jira Toolkit Integration Guide](../../integrations/toolkits/jira_toolkit) - Complete Jira toolkit reference
