...
<Info title="GitHub as Primary Example">
...
1. **GitHub Credential**: A Personal Access Token or [GitHub App credentials](../credentials-toolkits/how-to-use-credentials#github-credential-setup) configured in ELITEA
...
- [GitHub Credential Setup](../credentials-toolkits/how-to-use-credentials#github-credential-setup)
- [GitHub Toolkit Guide](../../integrations/toolkits/github_toolkit) (Token generation section)
</Info>
...
- [GitHub Toolkit Integration Guide](../../integrations/toolkits/github_toolkit)
</Info>
...
- [How to create and use indexes](./using-indexes-tab-interface) - Comprehensive guide for indexing functionality
- [Create a Credential](../../getting-started/create-credential) - Step-by-step credential creation guide
- [How to Use Credentials](../credentials-toolkits/how-to-use-credentials) - Credential management and GitHub setup
- [Toolkits Menu](../../menus/toolkits) - Toolkit configuration and management
- [GitHub Toolkit Integration Guide](../../integrations/toolkits/github_toolkit) - Complete GitHub toolkit reference
