...
- [Confluence Credential Setup](../credentials-toolkits/how-to-use-credentials#confluence-credential-setup)
- [Confluence Toolkit Guide](../../integrations/toolkits/confluence_toolkit) (Token generation section)
</Info>
