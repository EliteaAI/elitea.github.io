...
- Vector Storage: PgVector selected in Settings → [AI Providers](../../menus/settings/ai-configuration).
- Embedding Model selected in Settings → [AI Providers](../../menus/settings/ai-configuration).
...
1. Open your toolkit detail page.
2. The **Indexes** section appears in the right panel.
3. Select **+ Index**.
...
1. Open your toolkit detail page.
2. Select an existing index card from the Indexes section.
3. Click the **Search** button in the page header.
4. Select **Select Tool** in the left panel.
...
1. Open your toolkit detail page.
2. Select an index card from the Indexes section.
3. On the index detail page, click **Delete Index** link in the left panel.
...
1. Open your toolkit detail page.
2. The Indexes section appears in the right panel showing all available index cards.
