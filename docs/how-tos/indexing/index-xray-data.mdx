---
title: "Index Xray Data"
description: "This document provides a complete step-by-step walkthrough for indexing Xray Cloud data and then searching or chatting with the indexed content using ELITEA's AI-p"
---
...
1. **Xray Credential**: Xray Cloud API credentials with [Client ID and Client Secret](../credentials-toolkits/how-to-use-credentials#xray-credential-setup) configured in ELITEA
...
- [Xray Credential Setup](../credentials-toolkits/how-to-use-credentials#xray-credential-setup)
</Info>
...
1. **Create Toolkit**: Navigate to [**Toolkits**](../../menus/toolkits) → **+ Create** → **XRAY Cloud**
...
<Info title="JQL or GraphQL Required">
...
- [Indexing Overview](./indexing-overview) - Comprehensive doc to ELITEA indexing
- [Indexing Tools Reference](./indexing-tools) - Complete toolkit settings and parameters
- [Using the Indexes Tab Interface](./using-indexes-tab-interface) - Detailed interface document
- [Toolkits Menu](../../menus/toolkits) - General toolkit management
- [Create a Credential](../../getting-started/create-credential) - Credential setup document
- [Xray Credential Setup](../credentials-toolkits/how-to-use-credentials#xray-credential-setup) - Xray-specific credential configuration
</Info>
