...
description: "This guide provides a complete step-by-step walkthrough for indexing Xray Cloud data and then searching or chatting with the indexed content using ELITEA's AI-p"
---
...
- [Indexing Overview](./indexing-overview) - Comprehensive guide to ELITEA indexing
- [Indexing Tools Reference](./indexing-tools) - Complete toolkit settings and parameters
- [Using the Indexes Tab Interface](./using-indexes-tab-interface) - Detailed interface guide
- [Toolkits Menu](../../menus/toolkits) - General toolkit management
- [Create a Credential](../../getting-started/create-credential) - Credential setup guide
