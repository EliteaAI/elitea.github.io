---
title: "Index Zephyr Data"
description: "This document provides a complete step-by-step walkthrough for indexing Zephyr test management data and then searching or chatting with the indexed content using E"
---
...
- [Credentials and Toolkits Guide](../credentials-toolkits/how-to-use-credentials)
</Info>
...
1. **Create Toolkit**: Navigate to [**Toolkits**](../../menus/toolkits) → **+ Create** → **Zephyr Scale**
...
1. **Create Toolkit**: Navigate to [**Toolkits**](../../menus/toolkits) → **+ Create** → **Zephyr Enterprise**
...
1. **Create Toolkit**: Navigate to [**Toolkits**](../../menus/toolkits) → **+ Create** → **Zephyr Essential**
...
- [Credentials and Toolkits Guide](../credentials-toolkits/how-to-use-credentials) - Product-specific credential configuration
</Info>
