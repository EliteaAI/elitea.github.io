...
description: "This guide explains how to set up toolkits in team projects so each user operates with their own personal credentials instead of shared project credentials. Thi"
---
...
**A:** No, only toolkits that require credentials can use this functionality. Toolkits without credential requirements cannot leverage user-specific credentials. List of the toolkits can be found on following page [How to Use Credentials](./how-to-use-credentials)
...
- [How to Use Credentials](./how-to-use-credentials)
- [Credentials Management](../../menus/credentials)
- [About Toolkits](../../menus/toolkits)
- [Security Best Practices](../../menus/settings/secrets)