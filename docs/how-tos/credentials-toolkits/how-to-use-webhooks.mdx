---
title: "Guide: Configuring Webhooks to Trigger Elitea Agents"
sidebarTitle: "Webhooks for Agents"
description: "This guide provides comprehensive instructions for configuring ELITEA webhooks in GitHub and GitLab to trigger your Elitea agents. When a specified event occurs"
---

This document covers setting up webhooks in GitHub and GitLab, configuring your Elitea agent to receive them securely, and examples for testing your setup.

## Overview of Webhooks with Elitea
