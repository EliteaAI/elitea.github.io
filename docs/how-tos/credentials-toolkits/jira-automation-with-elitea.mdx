---
title: "Guide: Automated JIRA Issue Review with Elitea AI Agents"
sidebarTitle: "JIRA Review Automation"
description: "This guide provides comprehensive instructions on setting up an automated JIRA issue review process using Elitea AI agents and JIRA Automation. By following the"
---

This document covers understanding the API trigger mechanism, setting up the JIRA Automation rule, and troubleshooting common issues. The example here can be adapted for other ELITEA + JIRA workflows.

## Overview of the Automated JIRA Review Process
...
*   **JIRA Toolkit (Elitea):** A set of tools within an Elitea agent that allows it to interact with JIRA (More about  **[Jira toolkit](../../integrations/toolkits/jira_toolkit)** here)
...
2.  **Create or Configure Agent:**
    ...
    *   **Add JIRA Toolkit:** If not already present, add the "JIRA" toolkit to your agent and configure it with your JIRA instance ( More about  **[Jira toolkit](../../integrations/toolkits/jira_toolkit)** here).
