---
title: "Credentials User Guide"
sidebarTitle: "Use Credentials"
description: "This user guide provides a comprehensive overview of the Credentials feature in ELITEA and how to use these credentials when configuring toolkits. The Credentia"
---
...
For more information on creating and managing Toolkits, see the [Toolkits documentation](../chat-conversations/how-to-create-and-edit-toolkits-from-canvas).
