...
<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Set Up a Local MCP Server (STDIO)](./create-and-use-server-stdio) for up-to-date content.
</Warning>
...
- See the [SSE Transport guide](./mcp-server-sse) for details
...
- **Project ID**  
  You'll need your Elitea Project ID to connect to the MCP Server. You can find your Project ID in the [Settings Configuration section](../../menus/settings/ai-configuration) of the Elitea web interface.
...
- [ELITEA SSE Transport Integration](./mcp-server-sse)
