...
<Warning>
  This page contains outdated information and is no longer maintained. Please refer to the [Set Up a Local MCP Client (STDIO)](./create-and-use-client-stdio) for up-to-date content.
</Warning>
