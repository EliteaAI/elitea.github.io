---
title: "Expose Elitea Toolkits' Tools Through MCP"
sidebarTitle: "Expose Elitea Tools via MCP"
...
<Tip title="Selective Tool Exposure">
...
2. **Set Up MCP Server Connection**:
    ...
    * See the [MCP Server Integration Guide](./mcp-server-sse) for detailed setup
...
<Info title="Agent vs. MCP Tagging">
...
* **[MCP Server Integration via STDIO](./create-and-use-server-stdio)** – Alternative MCP connection method
* **[Toolkits](../../menus/toolkits)** – Complete guide to toolkit configuration
* **[MCPs Menu](../../menus/mcps)** – Managing external MCP servers (reverse direction)
</Info>
