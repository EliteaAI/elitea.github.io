...
sidebarTitle: "Set Up a Local MCP Server (STDIO)"
description: "Set up a local MCP server that connects Elitea to VS Code, including bootstrap, configuration, and Copilot integration steps."
---
...
4. **Install elitea-mcp**
   ...
   ![Install elitea-mcp](../../img/integrations/mcp/mcp-setup/install-elitea-mcp.gif)
...
<img src="../../img/integrations/mcp/mcp-setup/elitea-mcp-bootstrap-server.gif" alt=" elitea-mcp-server" />
