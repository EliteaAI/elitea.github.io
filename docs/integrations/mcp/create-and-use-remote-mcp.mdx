---
title: "Connect Remote MCP Servers with Elitea"
sidebarTitle: "Remote MCP Servers"
description: "Connect HTTP-based remote MCP servers to Elitea using bearer tokens or OAuth so agents can use shared external tools."
---
...
<Info title="No Local Installation Required">
...
<Info title="OAuth Callback (Redirect) URL">
...
<Info title="OAuth Metadata Discovery">
...
<img src="../../img/integrations/mcp/remote-mcp/remote-mcp-access.gif" alt="Remote MCP" />
...
<img src="../../img/integrations/mcp/remote-mcp/remote-mcp-configure.gif" alt="MCP config" />
...
<Info title="Authentication Priority">
...
<img src="../../img/integrations/mcp/remote-mcp/github-auth-headers.gif" alt="1" />
...
```
  ...
  <img src="../../img/integrations/mcp/remote-mcp/github-oauth.png" alt="1" />

<Info title="Scope Selection">
...
<Info title="No Pre-Configuration Required">
...
<Warning title="Admin Requirements">
...
- **URL**: `https://mcp.atlassian.com/v1/mcp`
  ...
  !!! info "Atlassian Rovo MCP Endpoint"
...
<img src="../../img/integrations/mcp/remote-mcp/test-tools.gif" alt="test" />

<Tip title="Testing Best Practices">
...
<Info>
When a Remote MCP is added to an agent, pipeline, or chat, the MCP card shows its connection controls directly on the toolkit. Depending on the authentication state, users can see a visible status indicator, a **Log In** button to start or repeat authorization, and a **Logout** button to disconnect the current session.

<img src="../../img/integrations/mcp/remote-mcp/remote-mcp-card.png" alt="Remote MCP Card" />
</Info>
...
<img src="../../img/integrations/mcp/remote-mcp/mcp-add-agent.gif" alt="Aget" />
...
<img src="../../img/integrations/mcp/remote-mcp/mcp-add-pipeline.gif" alt="Pipelines" />         
...
<img src="../../img/integrations/mcp/remote-mcp/mcp-add-chat.gif" alt="chat" />
...
<Accordion title="OAuth Flow Issues">
...
<Accordion title="Tool Discovery Failures">
...
<Accordion title="Atlassian Rovo MCP Server: Organization Admin Must Authorize Domain">
...
<Accordion title="Can I use multiple Remote MCPs in the same agent or pipeline?">
...
<Accordion title="What's the difference between Remote MCP and Stdio MCP?">
...
<Accordion title="Do I need to create OAuth applications for every Remote MCP?">
...
<Accordion title="Can I share Remote MCPs across my team?">
...
<Accordion title="How do I update my Remote MCP configuration?">
...
<Accordion title="What happens if my OAuth token expires?">
...
<Accordion title="Can I use Remote MCPs with custom or self-hosted MCP servers?">
...
<Accordion title="How do I test if my Remote MCP is working correctly?">
...
<Accordion title="What should I do if tools aren't appearing after clicking 'Get / Sync tools'?">
...
<Accordion title="Can I limit which tools are available to my agents?">
...
<Accordion title="Do Remote MCPs work offline?">
No, Remote MCPs require network connectivity to the MCP server. If you need offline functionality, consider using [Stdio MCP servers](./create-and-use-client-stdio) instead.
</Accordion>

<Accordion title="How do I handle rate limits from my MCP provider?">
...
<Accordion title="Can I migrate from Stdio MCP to Remote MCP (or vice versa)?">
...
<Accordion title="What OAuth scopes should I request for GitHub/Atlassian MCPs?">
...
<Accordion title="How do I troubleshoot 'Authorization header format' errors?">
...
- [Stdio MCP Client Setup](./create-and-use-client-stdio)
