---
title: "Quick Start: Set Up a Local MCP Client (STDIO)"
sidebarTitle: "Set Up a Local MCP Client (STDIO)"
description: "Set up Elitea as a local MCP client and connect STDIO-based tools such as Playwright, GitHub, or Figma."
---
