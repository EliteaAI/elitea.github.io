...
4. **Install elitea-mcp**
     ...
     ![alt text](../../img/integrations/mcp/mcp-setup/install-elitea-mcp.gif)
...
3. **Add an MCP Server** (example: Playwright)
     ...
     <img src="../../img/integrations/mcp/mcp-setup/elitea-mcp-bootstrap-client.gif" alt="alt text" />
...
1. **Start the tray application**
     ...
     - You should see the Elitea icon appear in your system tray
      ...
      ![mcp](../../img/integrations/mcp/mcp-tray.png)
...
2. **Start the MCP Server from the tray**
     ...
     - Select **Start MCP Server**
      ...
      ![Windows tray menu](../../img/integrations/mcp/mcp-tray-windows.gif)
