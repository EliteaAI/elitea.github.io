...
3. **Select Jira:** Choose **Jira** from the list of available toolkit types.
     ...
     ![Jira create Toolkit](../../img/integrations/toolkits/jira/jira-toolkit-access.gif)
...
4. **Configure Toolkit Details:**
   ...
   | **Credential** | Required | — | Select the Jira credential created in Step 1 |
   ...
   | **API Version** | Optional | Auto | REST API version. **Auto** selects automatically based on the Hosting setting in the linked credential (Cloud → V3, Server → V2). Set **V3** for Jira Cloud or **V2** for Jira Server / Data Center if Auto does not resolve correctly |
...
| | **Add file to issue description** | Attach a file and embed it in the issue description | Enrich issue descriptions with supporting files or screenshots |
