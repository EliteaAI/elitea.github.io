...
3. **Select Confluence:** Choose **Confluence** from the list of available toolkit types.
     ...
     ![Confluence Toolkit Access](../../img/integrations/toolkits/confluence/confluence-toolkit-access.gif)
...
6. **Save Toolkit:** Click **Save** to create the toolkit.
     ...
     ![Confluence Toolkit](../../img/integrations/toolkits/confluence/confluence-toolkit-create.gif)
...
<Note title="External Confluence Resources">
