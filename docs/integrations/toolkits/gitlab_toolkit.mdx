---
title: "GitLab"
description: "Connect ELITEA to GitLab — manage repositories, merge requests, issues, and CI/CD pipelines from your agents."
---
...
4.  **Add New Token:** Click the **"Add new token"** button to create a new Personal Access Token.
     ...
     <img src="../../img/integrations/toolkits/gitlab/access-gitlab-token-section.gif" alt="Navigate to Access Tokens" />
...
6. **Save Credential:** Click **Save** to create the credential
     ...
     <img src="../../img/integrations/toolkits/gitlab/gitlab-credential-create.gif" alt="Credentials" />

     !!! tip "Security Recommendation"
         It's highly recommended to use **[Secrets](../../menus/settings/secrets)** for Personal Access Tokens instead of entering them directly. Create a secret first, then reference it in your credential configuration.
...
3. **Select GitLab:** Choose **GitLab** from the list of available toolkit types.
    <img src="../../img/integrations/toolkits/gitlab/gitlab-toolkit-access.png" alt="GitLab Toolkit Access" />
...
<video src="../../img/integrations/toolkits/gitlab/gitlab-toolkit-create.mp4" controls></video>
...
|:------------:|---------------|-----------------|
| **Read** | | |
| | **Get commits** | Retrieves a list of commits from the repository with optional filtering by SHA, path, date range, and author |
| | **Get issue** | Retrieves complete details of a specific issue by number including the first 10 comments |
| | **Get issues** | Retrieves all open issues from the repository with their titles, descriptions, labels, and metadata |
| | **Get merge request** | Retrieves complete details of a specific merge request |
| | **Get pr changes** | Retrieves the diff/changes from a merge request showing file modifications, additions, and deletions |
| | **Grep file** | Searches for text/patterns within a specific file's content (like grep/ripgrep) |
| | **List branches in repo** | Lists branches in the repository with optional limit parameter (default: 20) and wildcard filtering support |
| | **List files** | Lists files in the repository with optional path filter and branch specification |
| | **List folders** | Lists folders in the repository with optional path filter, recursive/non-recursive search control, and branch specification |
| | **List indexes** | Lists all available indexed collections in the PgVector database |
| | **List merge requests** | Retrieves a list of merge requests from the repository |
| | **Read file** | Reads and returns the complete contents of a file from the repository at the specified branch |
| | **Read multiple files** | Reads and returns contents of multiple files in a single operation |
| | **Search index** | Performs semantic searches across indexed repository content using natural language queries |
| | **Stepback search index** | Performs advanced contextual searches with broader scope using step-back prompting |
| | **Stepback summary index** | Creates comprehensive summaries of indexed content using step-back prompting |
| **Create & update** | | |
| | **Append file** | Appends new content to the end of an existing file without overwriting existing content |
| | **Comment on issue** | Adds a comment to an existing GitLab issue with support for markdown formatting |
| | **Comment on pr** | Adds a general comment to a merge request for discussion or feedback |
| | **Create branch** | Creates a new branch from the active branch. Automatically sets the new branch as active after creation |
| | **Create file** | Creates a new file in the GitLab repository at the specified path with provided contents and commits it to the specified branch |
| | **Create pr change comment** | Adds a comment to specific changes within a merge request at a particular file path and line number |
| | **Create pull request** | Creates a merge request from the specified branch to the main branch using JSON data specification |
| | **Index data** | Loads GitLab repository data into PgVector for semantic search |
| | **Set active branch** | Switches the active branch for subsequent operations. Validates branch existence before switching |
| | **Update file** | Updates an existing file using OLD/NEW marker format for content replacement |
| **Delete** | | |
| | **Delete branch** | Deletes a branch from the repository with proper validation and error handling |
| | **Delete file** | Deletes a file from the repository with proper commit message and branch specification |
| | **Remove index** | Removes previously created search indexes from PgVector |

<Tip title="Vector Search Tools">
The tools **Index data**, **List indexes**, **Remove index**, **Search index**, **Stepback search index**, and **Stepback summary index** require PgVector configuration and an embedding model. These enable advanced semantic search capabilities across your GitLab repository.
</Tip>
...
3. **Add GitLab Toolkit:** 
    ...
    <img src="../../img/integrations/toolkits/gitlab/gitlab-agent-add.png" alt="GitLab Agent" />
...
3. **Add GitLab Toolkit:** 
    ...
    <img src="../../img/integrations/toolkits/gitlab/gitlab-pipeline-add.png" alt="GitLab Pipeline" />
...
3. **Add GitLab Toolkit to Conversation:**
   - Click the **`+`** icon in the chat input toolbar (tooltip: *Add files, agents, toolkits and more…*)
   - Hover over **Toolkits** in the popup menu
   - Search for your GitLab toolkit by name
   - Enable the toolkit to add it to your conversation
4. **Verify Toolkit Added:** The GitLab toolkit appears in the **PARTICIPANTS** panel on the right side under the **Toolkits** section.
5. **Use Toolkit in Chat:** You can now directly interact with your GitLab repositories by asking questions or requesting actions that will trigger the GitLab toolkit tools.

    <img src="../../img/integrations/toolkits/gitlab/gitlab-chat-add.png" alt="GitLab Chat" />
...
<Accordion title="Branch Management - List Branches">
**Chat Example:**
```
...
<Accordion title="File Operations - Create File">
**Chat Example:**
```
...
<Accordion title="Issue Management - Get Issues">
**Chat Example:**
```
...
<Accordion title="Merge Request Management - Create Merge Request">
**Chat Example:**
```
...
<Accordion title="Version Control - Get Commits">
**Chat Example:**
```
...
<Accordion title="Automated Branch Creation">
...
<Accordion title="Issue Tracking and Management">
...
<Accordion title="Repository Analysis">
...
<Accordion title="Continuous Integration Support">
...
<Accordion title="File Management Automation">
...
<Accordion title="Branch Operation Failures">
**Possible Error Messages:**
...
<Accordion title="File Operation Failures">
**Possible Error Messages:**
...
<Accordion title="Merge Request Issues">
**Possible Error Messages:**
...
<Accordion title="Indexing and Search Issues">
**Possible Error Messages:**
...
<Accordion title="Python-GitLab Library Issues">
**Possible Error Messages:**
...
If you encounter issues not covered in this guide or need additional assistance with GitLab integration, please refer to **[Contact Support](../../support/contact-support)** for detailed information on how to reach the ELITEA Support Team.

---

## FAQ

<Accordion title="Q: Can I use my regular GitLab password instead of a Personal Access Token?">
...
<Accordion title="Q: What are the minimum required scopes for the Personal Access Token?">
...
<Accordion title="Q: What is the correct format for specifying the repository name?">
...
<Accordion title="Q: Can I use both GitLab.com and self-hosted GitLab instances?">
...
<Accordion title="Q: How do I switch the active branch for operations?">
...
<Accordion title="Q: Why am I getting 'Permission Denied' errors?">
...
<Accordion title="Q: How do merge requests (MRs) work in GitLab vs pull requests (PRs) in other platforms?">
...
<Accordion title="Q: Can I work with multiple repositories in one toolkit?">
...
<Accordion title="Q: How does semantic search work with GitLab repositories?">
...
<Accordion title="Q: What's the difference between update_file, edit_file, and append_file?">
...
<Accordion title="Q: How do I handle errors in file operations?">
...
<Accordion title="Q: Can I delete branches, and are there any restrictions?">
...
<Accordion title="Q: What are read_file_chunk and read_multiple_files tools used for?">
...
<Accordion title="Q: How do commit messages work, and can I customize them?">
...
<Accordion title="Q: What should I do about 'Change for file wasn't found in PR' errors?">
...
* **[How to Use Chat Functionality](../../how-tos/chat-conversations/how-to-use-chat-functionality)** — Learn interactive GitLab operations in Chat
* **[Create and Edit Agents from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-agents-from-canvas)** — Quick agent creation for GitLab automation
* **[Create and Edit Toolkits from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-toolkits-from-canvas)** — Streamline GitLab toolkit configuration
* **[Create and Edit Pipelines from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-pipelines-from-canvas)** — Build automated GitLab workflows
* **[Indexing Overview](../../how-tos/indexing/indexing-overview)** — Enable semantic search across GitLab repositories
* **[Index Repo Data](../../how-tos/indexing/index-github-data)** — Instructions for indexing repository content (applicable to GitLab)
</Info>
