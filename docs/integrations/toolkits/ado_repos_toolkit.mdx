...
<Info title="How to Get Repository ID">
...
<Accordion title="What is the correct format for the Repository ID in the Azure Repos toolkit configuration?">
