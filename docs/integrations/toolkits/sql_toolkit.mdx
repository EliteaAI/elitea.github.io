---
title: "SQL"
description: "Connect ELITEA to SQL databases — run queries, retrieve data, and automate database operations from your agents."
---
...
To learn more about integrating SQL with ELITEA, explore these related guides and references:
