---
title: "ReportPortal"
description: "Connect ELITEA to ReportPortal — query test results, launches, and defects to automate testing insights and reporting."
---
...
To learn more about integrating ReportPortal with ELITEA, explore these related guides and references:
...
*   **[ELITEA Secrets](../../menus/settings/secrets)**: Learn how to securely store your ReportPortal API Key using ELITEA's Secrets management feature for enhanced security.
*   **[ELITEA Agents Configuration](../../menus/agents)**:  Find out more about creating and configuring Agents in ELITEA, where you integrate the ReportPortal toolkit to automate your workflows.
