...
5. **Configure Authentication Method:** Choose one of the following based on your API requirements:
     ...
     * **OAuth (Delegated):** For delegated OAuth flows that use an OAuth discovery endpoint and interactive login
     * **OAuth (Client Credentials):** For machine-to-machine OAuth flows using client credentials and token exchange
