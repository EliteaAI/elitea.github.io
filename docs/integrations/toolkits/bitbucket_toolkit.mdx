---
title: "Bitbucket"
description: "Connect ELITEA to Bitbucket — manage repositories, branches, pull requests, and code reviews from your agents."
---
...
<Warning title="App Passwords Deprecated">
...
9.  **Copy and Store Token:** **Copy the generated API Token immediately** — this is your only chance to see it. Store it securely in a password manager or ELITEA's **[Secrets](../../menus/settings/secrets)** feature.

    <img src="../../img/integrations/toolkits/bitbucket/generate-api-token.gif" alt="Bitbucket-API_Token" />
...
6. **Save Credential:** Click **Save** to create the credential
     ...
     <img src="../../img/integrations/toolkits/bitbucket/bitbucket-credential-create.gif" alt="Credentials" />

<Tip title="Security Recommendation">
It's highly recommended to use **[Secrets](../../menus/settings/secrets)** for API Tokens instead of entering them directly. Create a secret first, then reference it in your credential configuration.
</Tip>
...
6. **Save Toolkit:** Click **Save** to create the toolkit
    ...
    <video width="750" controls>
        <source src="../../img/integrations/toolkits/bitbucket/bitbucket-toolkit-create.mp4" type="video/mp4"/>
    </video>

#### Available Tools:

The Bitbucket toolkit provides 23 tools for interacting with Bitbucket repositories, organized into 3 categories as shown in the UI:

| **Category** | **Tool Name** | **Description** | **Primary Use Case** |
|:------------:|---------------|-----------------|----------------------|
| **Read** | | | |
...
| | **List indexes** | Lists all available indexed collections in the PgVector database to identify searchable datasets | View and manage indexed data collections to understand what code bases are searchable |
| | **Read file** | Reads and returns the complete contents of a file from the repository at the specified branch. Supports partial reads with start_line and end_line parameters for reading specific sections of large files | Retrieve file contents for review, analysis, or processing by the AI agent |
...
| | **Update file** | Updates an existing file using OLD/NEW marker format for content replacement. Validates changes and provides detailed error messages if markers are malformed. Markers must be on dedicated lines | Modify existing file contents with explicit old-to-new content transformations |
| **Delete** | | | |
...
| | **Delete file** | Deletes a file from the repository at the specified path on the specified branch with an optional commit message | Remove obsolete files, clean up temporary files, or delete configuration files no longer needed |
...
3. **Add Bitbucket Toolkit:**
     ...
     * The toolkit will be added to your agent with the previously configured tools enabled
     ...
     <img src="../../img/integrations/toolkits/bitbucket/bitbucket-agent-add.gif" alt="Agent" />
...
3. **Add Bitbucket Toolkit:**
     ...
     * The toolkit will be added to your pipeline with the previously configured tools enabled
     ...
     <img src="../../img/integrations/toolkits/bitbucket/bitbucket-pipeline-add.gif" alt="Pipeline" />
...
4. **Use Toolkit in Chat:** You can now directly interact with your Bitbucket repository by asking questions or requesting actions that will trigger the toolkit tools
     ...
     <img src="../../img/integrations/toolkits/bitbucket/bitbucket-chat-add.gif" alt="Chat" />
...
<Accordion title="Pull Request Management - Add PR Comment">
**Chat Example:**
```
...
<Accordion title="Pull Request Issues">
...
If you encounter issues not covered in this guide or need additional assistance with Bitbucket integration, please refer to **[Contact Support](../../support/contact-support)** for detailed information on how to reach the ELITEA Support Team.     

---

## FAQ

<Accordion title="Can I use my regular Bitbucket password instead of an API Token?">
...
<Accordion title="What are the minimum scopes needed for the API Token?">
...
<Accordion title="What happened to App Passwords?">
...
<Accordion title="Can I use this toolkit with Bitbucket Server or Data Center?">
...
<Accordion title="How do I know which branch is currently active?">
...
<Accordion title="Why can't my Agent create pull requests?">
...
<Accordion title="Can I use this toolkit with multiple repositories?">
...
<Accordion title="What's the difference between 'edit_file' and 'update_file' tools?">
...
<Accordion title="How do I handle branch names with special characters or slashes?">
...
<Accordion title="Can I use this toolkit for repository indexing and semantic search?">
...
<Accordion title="What file operations are supported and are there any size limits?">
...
* **[How to Use Chat Functionality](../../how-tos/chat-conversations/how-to-use-chat-functionality)** — Learn interactive Bitbucket operations in Chat
* **[Create and Edit Agents from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-agents-from-canvas)** — Quick agent creation for Bitbucket automation
* **[Create and Edit Toolkits from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-toolkits-from-canvas)** — Streamline Bitbucket toolkit configuration
* **[Create and Edit Pipelines from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-pipelines-from-canvas)** — Build automated Bitbucket workflows
* **[Indexing Overview](../../how-tos/indexing/indexing-overview)** — Enable semantic search across Bitbucket repositories
* **[Index Repo Data](../../how-tos/indexing/index-github-data)** — Instructions for indexing repository content (applicable to Bitbucket)
</Info>
