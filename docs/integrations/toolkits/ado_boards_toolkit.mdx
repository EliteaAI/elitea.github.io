...
3. **Select Azure Boards:** Choose **Azure Boards (ADO Board)** from the available toolkit types.
    ...
    <img src="../../img/integrations/toolkits/ado/ado-board-toolkit-access.png" alt="Azure Boards Toolkit Access" />
...
6. **Save Toolkit:** Click **Save**.
  ...
  <video src="../../img/integrations/toolkits/ado/ado-board-toolkit-create.mp4" controls></video>
...
|:------------:|---------------|-----------------|
| **Read** | | |
| | **Get comments** | Get comments for a work item by ID |
| | **Get image by url** | Analyze an image attachment from an Azure DevOps work item attachment URL |
| | **Get relation types** | Returns available relation types |
| | **Get work item** | Get a single work item by ID |
| | **Get work item type fields** | Get fields for a specific work item type |
| | **List indexes** | Lists available indexed indexes |
| | **Search index** | Performs searches across indexed content |
| | **Search work items** | Search for work items using a WIQL query and dynamically fetch fields |
| | **Search work items by text** | Search for work items using natural language text queries |
| | **Stepback search index** | Performs advanced contextual searches with broader scope |
| | **Stepback summary index** | Creates comprehensive summaries of indexed content |
| **Create & update** | | |
| | **Attach file to work item** | Upload a file from ELITEA artifacts and attach it to a work item |
| | **Create work item** | Creates new work items |
| | **Index data** | Loads Azure DevOps work item data to index for semantic search |
| | **Link work items** | Add a relation to the source work item |
| | **Link work items to wiki page** | Links work items to a specific wiki page using ArtifactLink |
| | **Unlink work items from wiki page** | Removes ArtifactLink between work items and a wiki page |
| | **Update work item** | Updates existing work items |
| **Delete** | | |
| | **Delete work item** | Deletes a work item by ID |
...
3. **Add the Toolkit:** In the **TOOLS** section, click **"+Toolkit"** and select your ADO Boards toolkit.

<img src="../../img/integrations/toolkits/ado/ado-board-agent-add.png" alt="Add to Agent" />
...
<img src="../../img/integrations/toolkits/ado/ado-board-pipeline-add.png" alt="Add to Pipeline" />
...
3. **Add ADO Boards Toolkit to Conversation:**
   - Click the **`+`** icon in the chat input toolbar (tooltip: *Add files, agents, toolkits and more…*)
   - Hover over **Toolkits** in the popup menu
   - Search for your ADO Boards toolkit by name
   - Enable the toolkit to add it to your conversation
4. **Verify Toolkit Added:** The ADO Boards toolkit appears in the **PARTICIPANTS** panel on the right side under the **Toolkits** section.
5. **Use Toolkit in Chat:** You can now directly interact with your Azure Boards projects by asking questions or requesting actions that will trigger the ADO Boards toolkit tools.

<img src="../../img/integrations/toolkits/ado/ado-board-chat-add.png" alt="Add to Chat" />
