---
title: "ELITEA Code Chat"
description: "ELITEA Code Chat extension is deprecated and no longer actively developed. Existing functionality may still be partially available. However, compatibility with "
---
