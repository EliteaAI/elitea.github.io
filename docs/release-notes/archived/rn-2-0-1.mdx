...
description: "ELITEA 2.0.1 adds image generation, sensitive-action approvals, HITL nodes, MCP OAuth improvements, and admin UI updates."
---

## Release Overview

ELITEA 2.0.1 focuses on safer execution flows, stronger MCP integrations, and a smoother experience across chat, artifacts, pipelines, and administration. It combines new end-user features like image generation and HITL support with important platform and configuration improvements.
...
For more information, see [Image Generation (Text-to-Image)](../../how-tos/chat-conversations/image-generation).
...
For more information, see [Control Flow Nodes](../../how-tos/pipelines/nodes/control-flow-nodes), [Nodes and Connectors](../../how-tos/pipelines/nodes-connectors), and [Pipelines](../../menus/pipelines).
...
For more information, see [Attachments in Conversations](../../how-tos/chat-conversations/attach-files) and [Artifacts](../../menus/artifacts).
...
For more information, see [SharePoint Integration Toolkit Guide](../../integrations/toolkits/sharepoint_toolkit) and [How to Index SharePoint Data](../../how-tos/indexing/index-sharepoint-data).
...
For more information, see [Artifacts Toolkit Guide](../../integrations/toolkits/artifact_toolkit), [Artifacts](../../menus/artifacts), and [The DOCX Editor](../../how-tos/chat-conversations/how-to-canvas#the-docx-editor).
...
For more information, see [Remote MCP Server Integration Guide](../../integrations/mcp/create-and-use-remote-mcp) and [MCPs](../../menus/mcps).
...
For more information, see [How to Use Chat Functionality](../../how-tos/chat-conversations/how-to-use-chat-functionality).
...
For more information, see [Forking](../../how-tos/agents-pipelines/forking), [Agent and Pipeline Versioning](../../how-tos/agents-pipelines/entity-versioning), and [Agents](../../menus/agents).
...
For more information, see [Import/Export Agents and Pipelines](../../how-tos/agents-pipelines/import-export), [Toolkits](../../menus/toolkits), and [Credentials](../../menus/credentials).
...
For more information, see [Agents](../../menus/agents), [Pipelines](../../menus/pipelines), and [Toolkits](../../menus/toolkits).
