---
title: "Release Notes - 2.0.0 Beta"
description: "ELITEA 2.0.0 Beta introduces image attachments, indexing tabs, Canvas creation flows, Python sandbox controls, and MCP-exposed toolkit tools."
---

## Release Overview

ELITEA 2.0.0 Beta introduces the first wave of major workflow changes for chat, indexing, Canvas, MCP, and pipeline management. It also marks several important platform transitions, including deprecations and new entity models that shape the 2.x direction.
...
* **Integrations replaced by Credentials**: Integrations are deprecated and replaced by Credentials as a standalone entity. Existing Integrations are not auto-migrated; recreate them as **Credentials** manually. See: [How to Use Credentials](../../how-tos/credentials-toolkits/how-to-use-credentials).
...
For detailed guidance, see [Attach Images and Files in Chat](../../how-tos/chat-conversations/attach-files).
...
For detailed guidance, see [Using Indexes Tab Interface](../../how-tos/indexing/using-indexes-tab-interface).
...
For detailed guidance, see [Create and Edit Pipelines from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-pipelines-from-canvas).
...
For detailed guidance, see [Create and Edit Toolkits from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-toolkits-from-canvas) and [Create and Edit MCPs from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-mcps-from-canvas).
...
For detailed guidance, see [Using the Python Sandbox Tool in Chat](../../how-tos/chat-conversations/python-sandbox-internal-tool).
...
For detailed guidance, see [View Agents and Pipelines History](../../how-tos/agents-pipelines/agents-pipelines-history).
...
For detailed guidance, see [Using Toolkits via MCP](../../integrations/mcp/make-tools-available-by-mcp).
...
For detailed guidance, see [Updating LLM Nodes in Pipelines](../../migration/v2.0.0/update-llm-nodes).
</Warning>
