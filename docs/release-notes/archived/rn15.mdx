...
description: "ELITEA 2.0.0 introduces default version management, import and export, Canvas file editing, smart tool loading, and broad UI improvements."
---

## Release Overview

ELITEA 2.0.0 is a major usability and platform update centered on version management, portability, and cleaner day-to-day workflows. It also expands Canvas, MCP history, chat organization, and UI consistency across core entities.
...
For more information, see [Agent and Pipeline Versioning](../../how-tos/agents-pipelines/entity-versioning).
...
<Warning title="No backward compatibility with pre-2.0.0 import/export">
...
For more information, see [Export and Import Guide](../../how-tos/agents-pipelines/import-export).
...
For more information, see [File Editing in Canvas](../../how-tos/chat-conversations/file-editing-canvas) and [Artifacts](../../menus/artifacts).
...
For more information, see [Smart Tools Selection Internal Tool](../../how-tos/chat-conversations/smart-tools-selection-internal-tool).
...
For more information, see [Swarm Mode Internal Tool](../../how-tos/chat-conversations/swarm-mode-internal-tool).
...
For more information, see [Azure DevOps Wiki, Boards, and Plans Toolkit Guide](../../integrations/toolkits/ado_wiki_plan_board_toolkit).
...
For more information, see [Chat](../../menus/chat).
...
For more information, see [MCPs](../../menus/mcps).
...
For more information, see [Langfuse](../../integrations/third-party-integrations/langfuse) and [Credentials](../../menus/credentials).
...
For more information, see [Settings Overview](../../menus/settings/settings-overview), [AI Configuration](../../menus/settings/ai-configuration), [Personal Tokens](../../menus/settings/personal-tokens), [Secrets](../../menus/settings/secrets), [Users](../../menus/settings/users), and [Monitoring](../../archive/monitoring).
...
For more information, see [Agents](../../menus/agents), [Pipelines](../../menus/pipelines), [Toolkits](../../menus/toolkits), [MCPs](../../menus/mcps), and [Credentials](../../menus/credentials).
...
For more information, see [MCPs](../../menus/mcps) and [Remote MCP Integration Guide](../../integrations/mcp/create-and-use-remote-mcp).
