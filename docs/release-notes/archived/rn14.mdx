---
title: "Release Notes - 2.0.0 B2"
description: "ELITEA 2.0.0 B2 adds remote MCP OAuth, Agents Studio, improved indexing and pipeline monitoring, planner support, and toolkit upgrades."
---

## Release Overview

ELITEA 2.0.0 B2 expands orchestration and collaboration with remote MCP improvements, Agents Studio, stronger indexing operations, and better pipeline execution visibility. It also includes a broad set of toolkit, credential, chat, and model-configuration enhancements.
...
For more information about this feature, see [Remote MCP Server Integration Guide](../../integrations/mcp/create-and-use-remote-mcp).
...
For more information about this feature, see [Use Public Agents](../../how-tos/chat-conversations/use-public-items-from-chat).
...
For detailed guidance, see [How to create and use indexes](../../how-tos/indexing/using-indexes-tab-interface) and
[Schedule Indexing](../../how-tos/indexing/schedule-indexing).
...
For detailed guidance, see [AI Assistant in Nodes](../../how-tos/pipelines/ai-assistant-in-nodes) and [Pipeline Runs](../../how-tos/pipelines/pipeline-runs).
...
For background on run history, see [Agents and Pipelines History](../../how-tos/agents-pipelines/agents-pipelines-history).
...
For detailed guidance, see [Pin Entities](../../how-tos/entity-management/working-with-pins).
...
For detailed guidance, see [Planner](../../how-tos/chat-conversations/planner-internal-tool).
...
For more information about this, see [Chat Usage](../../how-tos/chat-conversations/how-to-use-chat-functionality).
...
For more information about this feature, see [Attachements in Conversation](../../how-tos/chat-conversations/attach-files).
...
For more information about ADO credentials, see [How to Use Credentials](../../how-tos/credentials-toolkits/how-to-use-credentials#ado-azure-devops-credential-setup).
...
<Info title="Node Deprecation Timeline">
...
For detailed migration guidance, see [Migration Overview: migration/v2.0.0 B2/migration-overview.md](../../migration/v2.0.1/migration-overview).
...
For more information about this feature, see [Data Analysis](../../how-tos/chat-conversations/data-analysis-internal-tool).
