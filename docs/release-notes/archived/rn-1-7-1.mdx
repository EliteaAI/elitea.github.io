...
You can now set a project-wide default LLM model from **Settings → [AI Configuration](../../menus/settings/ai-configuration)**. The selected model becomes the default used across your project for:
...
For setup and usage details, see the [Memory Toolkit Guide](../../integrations/toolkits/memory_toolkit).
