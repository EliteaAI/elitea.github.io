...
description: "Discover ELITEA — your all-in-one platform for working with Generative AI and managing data-driven projects. ELITEA goes far beyond a simple repository: it’s a "
---
...
For usage details, see [Canvas in Conversation](../../how-tos/chat-conversations/how-to-canvas).
...
For setup and usage details, see the [Postman Toolkit Guide](../../integrations/toolkits/postman_toolkit).
...
<Tip>
You can also trigger indexing from an Agent or from Chat by selecting an Agent/Toolkit that has the Index Data tool, then instructing it to index the target (provide repo/site/project and scope). For an example, see [Index GitHub data](../../how-tos/indexing/index-github-data).
</Tip>
...
* **Personal Access Tokens**: Now a separate subsection under Settings for easier management. See [Personal Tokens](../../menus/settings/personal-tokens).
* **Secrets** and **Projects**: Both subsections have been enhanced and improved for clarity and usability. See [Secrets](../../menus/settings/secrets) and [Projects](../../menus/settings/users).
