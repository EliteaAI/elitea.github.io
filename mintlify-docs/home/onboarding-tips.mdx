---
title: "ELITEA Onboarding Tips"
description: "Welcome to ELITEA! While your workspace is being set up, explore these helpful tips to get started quickly and make the most of the platform. This is your guide"
---
...
* [Quick Start Guide](../getting-started/chat-quick-start) for detailed walkthroughs
* [Chat Documentation](../menus/chat) for comprehensive reference
* [Creating Agents](../how-tos/chat-conversations/how-to-create-and-edit-agents-from-canvas) for agent best practices
* [Pipeline Documentation](../menus/pipelines) for advanced workflow patterns
* [Glossary](../home/glossary) for definitions of all ELITEA terms
