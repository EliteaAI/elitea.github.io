...
description: "A toolkit is a collection of specialized tools and capabilities that extend what agents can do. Think of toolkits as skill sets that agents can use to interact "
---
...
Ready to explore available toolkits? Check out the [Toolkits menu](../../menus/toolkits) to see all supported integrations.
