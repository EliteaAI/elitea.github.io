---
title: "Migrate Datasources to Indexing"
description: "This guide explains how to migrate your existing Datasources from the Nexus environment to Indexing in the Next environment. The new indexing system provides be"
---
...
<Warning title="Deduplication Deprecated">
...
2. **Vector Storage**: Configure PgVector in Settings → [AI Configuration](../../menus/settings/ai-configuration)
3. **Embedding Model**: Select an embedding model in [AI Configuration](../../menus/settings/ai-configuration)
...
* **File/Table** → **[Artifact Toolkit](../../integrations/toolkits/artifact_toolkit)** or **[SharePoint Toolkit](../../integrations/toolkits/sharepoint_toolkit)**
* **Jira** → **[Jira Toolkit](../../integrations/toolkits/jira_toolkit)**
* **Confluence** → **[Confluence Toolkit](../../integrations/toolkits/confluence_toolkit)**
* **Git** → **[GitHub Toolkit](../../integrations/toolkits/github_toolkit)**
...
2. **Create SharePoint Credential**:
     * Create credential in **Credentials** → **+ Create** → **[SharePoint](../../how-tos/credentials-toolkits/how-to-use-credentials#sharepoint-credential-setup)**
...
For complete step-by-step instructions, see: 
   ...
   - **[Index SharePoint Data](../../how-tos/indexing/index-sharepoint-data)**
   - **[Index Artifacts Data](../../how-tos/indexing/index-artifacts-data)**
</Info>
...
1. **Create Jira Credential**:
     ...
     * Create credential in **[Credentials](../../how-tos/credentials-toolkits/how-to-use-credentials#jira-credential-setup)** → **+ Create** → **Jira**
...
<Info title="Detailed Instructions">
For complete step-by-step instructions, see: **[Index Jira Data](../../how-tos/indexing/index-jira-data)**
</Info>
...
1. **Create Confluence Credential**:
     ...
     * Create credential in **Credentials** → **+ Create** → **[Confluence](../../how-tos/credentials-toolkits/how-to-use-credentials#confluence-credential-setup)**
...
<Info title="Detailed Instructions">
For complete step-by-step instructions, see: **[Index Confluence Data](../../how-tos/indexing/index-confluence-data)**
</Info>
...
1. **Create Repository Credential**:
     ...
     * Create credential in **Credentials** → **+ Create** → **[GitHub](../../how-tos/credentials-toolkits/how-to-use-credentials#github-credential-setup)**
...
<Info title="Detailed Instructions">
For complete step-by-step instructions, see: **[Index Repository Data](../../how-tos/indexing/index-github-data)**
</Info>
...
- **[Indexing Overview](../../how-tos/indexing/indexing-overview)** - *Complete guide to indexing system and capabilities*
- **[Indexing Tools](../../how-tos/indexing/indexing-tools)** - *Detailed reference for all indexing tools*
- **[Index Artifacts Data](../../how-tos/indexing/index-artifacts-data)** - *Index files and documents*
- **[Index Jira Data](../../how-tos/indexing/index-jira-data)** - *Index Jira issues and project data*
- **[Index Confluence Data](../../how-tos/indexing/index-confluence-data)** - *Index Confluence pages and spaces*
- **[Index SharePoint Data](../../how-tos/indexing/index-sharepoint-data)** - *Index SharePoint files and sites*
- **[Index Repository Data](../../how-tos/indexing/index-github-data)** - *Index GitHub repositories*
- **[AI Configuration](../../menus/settings/ai-configuration)** - *Configure vector storage and embedding models*
- **[Create a Credential](../../getting-started/create-credential)** - *Set up authentication for data sources*
- **[Toolkits Menu](../../menus/toolkits)** - *General toolkit configuration guide*
</Info>
