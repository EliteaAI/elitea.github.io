---
title: "Pipeline Migration Guide: Updating from Previous Versions"
description: "This guide provides instructions for migrating pipelines from earlier ELITEA versions (1.6, 1.7) to version 2.0. The migration process involves several importan"
---
...
<Note title="Additional Migration Changes">
For LLM node-specific changes and configurations, also read about [LLM Node Changes in the migration guide](update-llm-nodes). This covers important updates to LLM node behavior and configuration that complement the pipeline migration steps outlined in this document.
</Note>
...
<Warning title="Task Field Requirement">
...
<Tip title="Connection Management">
...
<Warning title="Agent Recreation May Be Required">
...
More about toolkit migration read here  [Next quick-start](../../migration/v1.7.0/next-quick-start)
