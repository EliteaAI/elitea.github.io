---
title: "Loop Node Deprecation and Migration Guide"
description: "The Loop node has been deprecated as of version 2.0.0 B2 and is no longer available for creating new pipelines. This node previously allowed automatic iteration"
---
...
<Warning title="Step Limit Warning">
...
<Note title="ELITEA Vision: Explicit Over Implicit">
...
<Tip title="Customizing the Loop">
...
<Tip title="Best Practices for Step Limits">
...
- **Router Node**: [Router Documentation](../../how-tos/pipelines/nodes/control-flow-nodes#router-node)
- **State Modifier**: [State Modifier Documentation](../../how-tos/pipelines/nodes/utility-nodes#state-modifier-node)
- **Code Node**: [Code Node Documentation](../../how-tos/pipelines/nodes/execution-nodes#code-node)
- **All Nodes**: [Nodes Overview](../../how-tos/pipelines/nodes/overview)