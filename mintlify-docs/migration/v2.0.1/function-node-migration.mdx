---
title: "Migrating from Function Node to Toolkit/MCP/Agent Nodes"
description: "The Function Node has been deprecated and is no longer available for creation in new pipelines starting from version 2.0.0 B2. While existing Function nodes in "
---
...
<img src="../../img/migration/v2.0.1/function-node/deprecated-function-node.png" alt="Deprecated Function Node" width="250" />

<Info title="No Automatic Migration">
...
<Tip title="For Standard Toolkit Operations">
...
<img src="../../img/migration/v2.0.1/function-node/toolkit-node.png" alt="Toolkit Node" width="300" />

### MCP Node

<Tip title="For Model Context Protocol Servers">
...
<img src="../../img/migration/v2.0.1/function-node/mcp-node.png" alt="MCP Node" width="300" />

### Agent Node

<Tip title="For AI Agent Execution">
...
<img src="../../img/migration/v2.0.1/function-node/agent-node.png" alt="Agent Node" width="300" />
...
<img src="../../img/migration/v2.0.1/function-node/function-node.png" alt="Function Node" width="300" />
...
<img src="../../img/migration/v2.0.1/function-node/function-to-toolkit.gif" alt="Function to Toolkit Migration" />
...
<img src="../../img/migration/v2.0.1/function-node/function-node-mcp.png" alt="Function Node (MCP)" width="250" />
...
<img src="../../img/migration/v2.0.1/function-node/function-to-mcp.gif" alt="Function to MCP Migration" />
...
<Accordion title="Choosing the Right Replacement Node">
...
<Accordion title="General Migration Tips">
...
<Accordion title="Toolkit/MCP Node Issues">
...
<Accordion title="Agent Node Issues">
...
<Accordion title="State Variable Issues">
...
* **[Toolkit Node](../../how-tos/pipelines/nodes/execution-nodes#toolkit-node)** - Detailed Toolkit node documentation
* **[MCP Node](../../how-tos/pipelines/nodes/execution-nodes#mcp-node)** - Model Context Protocol node documentation
* **[Agent Node](../../how-tos/pipelines/nodes/interaction-nodes#agent-node)** - Agent node documentation
* **[Pipeline States](../../how-tos/pipelines/states)** - Understanding state variables used in pipelines
* **[Node Connectors](../../how-tos/pipelines/nodes-connectors)** - How to connect nodes in pipelines
* **[YAML Configuration](../../how-tos/pipelines/yaml)** - Complete YAML syntax reference
* **[Flow Editor](../../how-tos/pipelines/flow-editor)** - Visual pipeline editing interface
</Info>
