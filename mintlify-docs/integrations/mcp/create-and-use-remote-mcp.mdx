---
title: "Remote MCP Server Integration Guide"
description: "Remote MCP servers are external services that implement the Model Context Protocol (MCP) and expose tools over HTTP/HTTPS connections. Unlike stdio MCP servers "
---
...
<Note title="No Local Installation Required">
...
<Note title="No Pre-Configuration Required">
