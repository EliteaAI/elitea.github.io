---
title: "Quick Start: Setting Up Your First MCP Server"
description: "By the end of this guide, you'll have a working MCP server that connects Elitea to VS Code, allowing you to use Elitea agents directly in your coding environmen"
---
...
<img src="../../img/getting-started/mcp/alita-mcp-bootstrap-server.gif" alt=" alita-mcp-server" />

<Note title="Skipping Project ID During Bootstrap">
...
3. **Add the "mcp" tag**
   ...
   <img src="../../img/getting-started/mcp/mcp-tag-agent.gif" alt="Tag Agent" />
...
<img src="../../img/getting-started/mcp/restart-server.gif" alt="Restart server" />
...
- [Full MCP STDIO Documentation](mcp-server-stdio)
