---
title: "Quick Start: Connect External Tools to Elitea with MCP"
description: "By the end of this guide, you'll have connected external tools (like Playwright for browser automation or GitHub for repository management) to your Elitea agent"
---
...
<Note title="Additional Dependencies">
...
3. **Add an MCP Server** (example: Playwright)
     ...
     <img src="../../img/getting-started/mcp/alita-mcp bootstrap.gif" alt="alt text" />
...
2. **Start the MCP Server from the tray**
     ...
     - Select **Start MCP Server**
      ...
      <img src="../../img/integrations/mcp/mcp-tray-windows.png" alt="Windows tray menu" />
...
<img src="../../img/getting-started/mcp/config-file-open.png" alt="Config file menu" width="300" />
</Tip>
...
<Note title="Example of correct configuration">
```json
{
...
5. **Save**
     - Click **Save** to create the MCP entry
      ...
      <img src="../../img/getting-started/mcp/mcp-toolkit-create.gif" alt="Create MCP" />
...
4. **Save your agent**
     ...
     <img src="../../img/getting-started/mcp/mcp-add-to-agent.gif" alt="alt text" />
...
<img src="../../img/getting-started/mcp/mcp-add-to-chat.gif" alt="Add Chat" />

<Note title="Real-World Example: Testing a Login Page">
...
<Accordion title="Problem: Errors when running 'alita-mcp serve' or 'alita-mcp tray' - need to upgrade client">
**Fix:**
...
- [Full MCP Client Documentation](../mcp/mcp-client)
