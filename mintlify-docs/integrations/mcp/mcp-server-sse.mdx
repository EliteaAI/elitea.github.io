---
title: "Elitea MCP Server Integration via SSE Transport"
description: "The Elitea platform now supports integration with MCP clients through its dedicated MCP Server, using Server-Sent Events (SSE) for real-time communication. This"
---
...
<Note title="MCP Client Compatibility">
...
<Note title="Multiple MCP Servers">
