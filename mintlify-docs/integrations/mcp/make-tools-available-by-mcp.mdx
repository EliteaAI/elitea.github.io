---
title: "Make Tools Available by MCP"
description: "The Make tools available by MCP feature enables you to expose selected toolkit tools through the Model Context Protocol (MCP) interface. When enabled, these too"
---
...
<Note title="Agent vs. MCP Tagging">
...
* **[MCP Server Integration via STDIO](mcp-server-stdio)** – Alternative MCP connection method
