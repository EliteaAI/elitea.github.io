---
title: "ELITEA Code"
description: "ELITEA Code extension is deprecated and no longer actively developed. Existing functionality may still be partially available. However, compatibility with curre"
---
