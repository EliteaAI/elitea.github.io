---
title: "ELITEA Toolkit Guide: Memory Integration"
description: "This guide is your definitive resource for integrating and utilizing the Memory toolkit within ELITEA. It provides a comprehensive, step-by-step walkthrough, fr"
---
...
1. **Navigate to AI Configuration:** Open the sidebar and select **Settings** → **[AI Configuration](../../menus/settings/ai-configuration)**.
...
<Info title="Memory Storage Behavior">
