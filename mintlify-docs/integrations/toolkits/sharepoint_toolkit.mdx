---
title: "SharePoint Toolkit Integration Guide"
description: "This guide is your definitive resource for integrating and utilizing the SharePoint toolkit within ELITEA. It provides a comprehensive, step-by-step walkthrough"
---
...
<Note title="URL is not shown in the UI">
...
<Note title="Delegated Permissions">
...
<Note title="Required OneNote Scopes">
...
<Note title="Short vs. Full URL scope format">
