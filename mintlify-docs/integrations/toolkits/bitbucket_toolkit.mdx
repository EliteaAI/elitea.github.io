---
title: "Bitbucket Toolkit Integration Guide"
description: "This guide is your comprehensive resource for integrating and utilizing the Bitbucket toolkit within ELITEA. It provides detailed, step-by-step instructions, fr"
---
...
6. **Save Toolkit:** Click **Save** to create the toolkit
     ...
     <img src="../../img/integrations/toolkits/bitbucket/bitbucket-credential-create.gif" alt="Toolkit" />
...
| | **Update file** | Updates an existing file using OLD/NEW marker format for content replacement. Validates changes and provides detailed error messages if markers are malformed | Modify existing file contents with explicit old-to-new content transformations | Modify existing file contents with explicit old-to-new content transformations |
