---
title: "ELITEA Toolkit Guide: ServiceNow Integration"
description: "This guide is your definitive resource for integrating and utilizing the ServiceNow toolkit within ELITEA. It provides a walkthrough, from setting up a ServiceN"
---
...
*   **[ELITEA Secrets Management](../../menus/settings/secrets)**: Learn how to securely store your ServiceNow password using ELITEA's Secrets feature.
*   **[ELITEA Agents Configuration](../../menus/agents)**: Find out more about creating and configuring Agents in ELITEA.
