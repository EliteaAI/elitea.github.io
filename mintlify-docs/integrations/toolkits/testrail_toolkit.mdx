---
title: "TestRail Toolkit Integration Guide"
description: "This guide is your comprehensive resource for integrating and utilizing the TestRail toolkit within ELITEA. It provides detailed, step-by-step instructions, fro"
---
...
4.  **Submit the Form:** Click on the **"Start Free Trial"** or similar button to submit the form. TestRail will send a confirmation email to the email address you provided.
    ...
    <img src="../../img/integrations/toolkits/testrail/TestRail-Account_Form.png" alt="TestRail-Account_Form" />
...
6. **Save Credential:** Click **Save** to create the credential
     ...
     <img src="../../img/integrations/toolkits/testrail/testrail-credential-create.gif" alt="Credentials" />

<Tip title="Security Recommendation">
It's highly recommended to use **[Secrets](../../menus/settings/secrets)** for API Keys instead of entering them directly. Create a secret first, then reference it in your credential configuration.
</Tip>
...
6. **Save Toolkit:** Click **Save** to create the toolkit
     ...
     <img src="../../img/integrations/toolkits/testrail/testrail-toolkit-create.gif" alt="Toolkit" />
...
<img src="../../img/integrations/toolkits/testrail/testrail-agent-add.gif" alt="TestRail Agent" />
...
<img src="../../img/integrations/toolkits/testrail/testrail-pipeline-add.gif" alt="TestRail Pipeline" />
...
<img src="../../img/integrations/toolkits/testrail/testrail-chat-add.gif" alt="TestRail Chat" />     
...
<Accordion title="Test Case Access - Get Case">
**Chat Example:**
```
...
<Accordion title="Test Case Access - Get Cases by Filter">
**Chat Example:**
```
...
<Accordion title="Test Case Management - Add Case">
**Chat Example:**
```
...
<Accordion title="Test Case Management - Update Case">
**Chat Example:**
```
...
<Accordion title="Suite Management - Get Suites">
**Chat Example:**
```
...
<Accordion title="Automated Test Case Review">
...
<Accordion title="Automated Test Case Creation">
...
<Accordion title="Test Case Maintenance">
...
<Accordion title="Priority-Based Test Selection">
...
<Accordion title="Semantic Test Case Discovery">
...
<Accordion title="Test Documentation Generation">
...
<Accordion title="Test Case Attachment Management">
...
<Accordion title="Project and Suite Access Issues">
**Possible Error Messages:**
...
<Accordion title="Test Case Creation/Update Failures">
**Possible Error Messages:**
...
<Accordion title="Suite Mode and API Compatibility Issues">
**Possible Error Messages:**
...
<Accordion title="Rate Limiting and Performance Issues">
**Possible Error Messages:**
...
<Accordion title="Bulk Operations and Data Validation Issues">
**Possible Error Messages:**
...
<Accordion title="File Attachment Issues">
**Possible Error Messages:**
...
If you encounter issues not covered in this guide or need additional assistance with Testrail integration, please refer to **[Contact Support](../../support/contact-support)** for detailed information on how to reach the ELITEA Support Team. 

---

## FAQ

<Accordion title="Q: Can I use my regular TestRail password instead of an API Key?">
...
<Accordion title="Q: Where do I find Project IDs, Suite IDs, and Section IDs?">
...
<Accordion title="Q: What are the priority_id and type_id values for my TestRail instance?">
...
<Accordion title="Q: How do I know which template_id to use when creating test cases?">
...
<Accordion title="Q: Can I index test case attachments?">
...
<Accordion title="Q: What's the difference between single suite and multiple suite modes?">
...
<Accordion title="Q: How do custom fields work in TestRail?">
...
<Accordion title="Q: Why do I get 'Invalid parameter for json_case_arguments' error?">
...
<Accordion title="Q: Can I bulk create test cases from a spreadsheet or file?">
...
<Accordion title="Q: How do I attach files to test cases?">
...
<Accordion title="Q: How can I debug TestRail API errors?">
...
<Accordion title="Q: What happens when test case indexing fails?">
...
<Accordion title="Q: How does semantic search work with TestRail test cases?">
...
<Accordion title="Q: What fields can I update in a test case?">
...
<Accordion title="Q: Can I update multiple test cases at once?">
...
* **[How to Use Chat Functionality](../../how-tos/chat-conversations/how-to-use-chat-functionality)** — Learn interactive TestRail operations in Chat
* **[Create and Edit Agents from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-agents-from-canvas)** — Quick agent creation for TestRail automation
* **[Create and Edit Toolkits from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-toolkits-from-canvas)** — Streamline TestRail toolkit configuration
* **[Create and Edit Pipelines from Canvas](../../how-tos/chat-conversations/how-to-create-and-edit-pipelines-from-canvas)** — Build automated TestRail workflows
* **[Indexing Overview](../../how-tos/indexing/indexing-overview)** — Enable semantic search across TestRail test cases
* **[Index TestRail Data](../../how-tos/indexing/index-testrail-data)** — Step-by-step guide for indexing TestRail test cases
</Info>
