---
title: "Attachments in Conversations"
description: "Attach files and images directly to chat conversations for AI-powered analysis. This feature enables multimodal interactions where AI can process visual content"
---
...
<img src="../../img/how-tos/chat-conversations/attachments/enable-attachment-agent.gif" alt="Attachment Settings" />
...
- The same applies when the agent is used as a nested agent inside another agent
     ...
     <img src="../../img/how-tos/chat-conversations/attachments/add-agent-with-attachments.gif" alt="Attachment Settings chat" />

<Info title="LLM Chat Conversations">
...
3. Click **Open** to attach selected files
     ...
     <img src="../../img/how-tos/chat-conversations/attachments/attachment-browse.gif" alt="Browse" width="500" />
...
3. Release to attach files
     ...
     <img src="../../img/how-tos/chat-conversations/attachments/attachment-drag&drop.gif" alt="Drag and Drop" width="500" />
...
3. Paste the image (Ctrl+V or Cmd+V)
     ...
     <img src="../../img/how-tos/chat-conversations/attachments/attachment-paste.gif" alt="Paste" width="500" />
...
3. Click the **Send** button
     ...
     <img src="../../img/how-tos/chat-conversations/attachments/chat-with-attachments.gif" alt="Chat UI with Attached Image Thumbnails" />
...
2. Two icons appear:
     ...
     <img src="../../img/how-tos/chat-conversations/attachments/attachment-hover-options.gif" alt="Hovering over an Attachment Thumbnail" />
...
<img src="../../img/how-tos/chat-conversations/attachments/delete-attachment.gif" alt="Delete Attachment Confirmation Pop-up" />
...
<img src="../../img/how-tos/chat-conversations/attachments/disable-attachment-agent.gif" alt="change settings" />
...
<img src="../../img/how-tos/chat-conversations/attachments/non-image-files.gif" alt="change settings" />
...
<Note title="Programming File Support">
...
<Accordion title="Paperclip icon is disabled">
...
<Accordion title="Cannot delete attachment with Also delete from artifact toolkit option">
...
- **[Data Analysis Internal Tool](data-analysis-internal-tool)** - Analyze CSV and data files with Pandas capabilities
