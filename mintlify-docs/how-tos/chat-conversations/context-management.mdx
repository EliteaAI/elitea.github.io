...
description: "The Context Management feature provides intelligent control over conversation token usage through automated message pruning and summarization. When enabled as a"
---
...
5. Click **✔** to store the secret
 ...
 <img src="../../img/how-tos/chat-conversations/context-management/context-manager-secret.gif" alt="Secret" width="600" />

<Warning title="Widget Visibility">
...
* **[Secrets Management](../../menus/settings/secrets)** - Managing project-level secrets including context_manager configuration
</Info>
