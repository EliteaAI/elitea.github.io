...
description: "Swarm Mode is an internal tool that enables multi-agent collaboration in ELITEA. When enabled, all child agents share the full conversation history and can hand"
---
...
<Note title="Handoff Tools Are Automatic">
...
<Note title="Swarm Mode Requires Child Agents">
