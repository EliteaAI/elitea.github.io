---
title: "Python Sandbox Internal Tool"
description: "The Python Sandbox internal tool enables secure Python code execution directly within your conversations using Pyodide (Python compiled to WebAssembly). This po"
---
...
<Accordion title="Combine with Data Analysis Internal Tool">
...
- [Data Analysis Internal Tool](data-analysis-internal-tool) - Complementary tool for working with uploaded CSV/Excel files
- [Swarm Mode Internal Tool](swarm-mode-internal-tool) - Multi-agent collaboration for complex workflows
- [Smart Tools Selection Internal Tool](smart-tools-selection-internal-tool) - Intelligent toolkit selection and management
- [Planner Internal Tool](planner-internal-tool) - Task planning and execution coordination
...
- [Toolkits Overview](../../menus/toolkits) - Understanding toolkits and internal tools
</Info>
