...
description: "The Image Generation feature enables AI-powered creation of images directly from text prompts within Chat conversations and Agents. When using an LLM model with"
---
...
* Proper project configuration by your administrator
     ...
     <img src="../../img/how-tos/chat-conversations/internal tools/image-generation/image-generation-model.gif" alt="Model" width="400" />
...
8. Use the model selector to choose a model with image generation capabilities (e.g., GPT-5.2, GPT-5.1, DALL-E 3).
     ...
     <img src="../../img/how-tos/chat-conversations/internal tools/image-generation/chat-image-creation.gif" alt="Chat Image Creation Configuration" width="700" />

<Note title="What appears in the Internal Tools popup">
...
8. Click **Save** at the top of the configuration page to persist the change.
     ...
     <img src="../../img/how-tos/chat-conversations/internal tools/image-generation/agent-image-creation.gif" alt="Agent Image Creation Configuration" width="700" />
...
<Note title="Storage and Deletion">
