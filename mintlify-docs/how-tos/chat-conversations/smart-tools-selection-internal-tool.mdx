---
title: "Smart Tools Selection Internal Tool"
description: "The Smart Tools Selection internal tool is an advanced optimization feature that dramatically reduces token usage when working with multiple toolkits in ELITEA."
---
...
<Accordion title="Internal Tools icon is not visible in the chat toolbar">
**Possible causes:**
...
<Note title="Compatibility with Other Internal Tools">
...
* **[Python Sandbox](python-sandbox-internal-tool)** - Python Sandbox internal tool
* **[Data Analysis](data-analysis-internal-tool)** - Data Analysis internal tool
