...
description: "The Planner internal tool enables you to create, manage, and track tasks and action items directly within conversations. This tool helps you organize multi-step"
---
...
<img src="../../img/how-tos/chat-conversations/internal tools/planner/planner-enable-chat.gif" alt="Internal Tools Button" width="700" />
...
<img src="../../img/how-tos/chat-conversations/internal tools/planner/planner-enable-agent.gif" alt="Agent Planner Configuration" width="700" />

<Info title="Agent vs Conversation Settings">
...
<Accordion title="Issue: Internal tools configuration updated But Planner Still Not Working">
**Possible causes:**
...
* **[Python Sandbox](python-sandbox-internal-tool)** - Python Sandbox and internal tools overview
