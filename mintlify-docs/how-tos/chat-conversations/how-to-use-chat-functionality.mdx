---
title: "How To Use Chat Functionality"
description: "ELITEA Chat is a powerful feature designed to centralize your interactions with various ELITEA components, enabling you to achieve optimal results efficiently."
---
...
<img src="../../img/menus/chat/chat-model-settings.gif" alt="Model" />
...
* **[Agents](how-to-create-and-edit-agents-from-canvas)**:
...
* **[Pipelines](how-to-create-and-edit-pipelines-from-canvas)**:
...
* **[Toolkits](how-to-create-and-edit-toolkits-from-canvas)**:
...
* **[MCPs](how-to-create-and-edit-mcps-from-canvas)** (Model Context Protocol servers):
