...
description: "The Sensitive Action Authorization Guardrail is a server-side security control that pauses agent execution whenever the agent is about to invoke a designated se"
---
