---
title: "How to Create and Edit MCPs from Canvas"
description: "This user guide provides a comprehensive overview of the MCP Canvas feature in ELITEA and how to create, configure, and manage Model Context Protocol (MCP) serv"
---
...
Before creating MCPs from canvas, ensure the **Elitea MCP Client** is installed and running with at least one MCP server configured. See the [MCP Client integration guide](../../integrations/mcp/mcp-client) for setup instructions.
</Info>
...
<Warning title="No MCP Types Available">
...
<Warning title="Server Connection Required">
...
- **[MCP Menu](../../menus/mcps)** - Complete reference for MCP management and testing options
- **[MCP Client Integration](../../integrations/mcp/mcp-client)** - Setup and configuration guide for Elitea MCP Client
- **[Connect External Tools to Elitea with MCP](../../integrations/mcp/create-and-use-client-stdio)** - Quick start guide for MCP client setup
- **[Setting Up MCP Server in VS Code](../../integrations/mcp/create-and-use-server-stdio)** - Quick start guide for MCP server setup
