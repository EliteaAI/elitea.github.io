---
title: "Data Analysis Internal Tool"
description: "Starting with release 2.0.0 B2, the legacy Pandas toolkit has been deprecated and replaced by the Data Analysis internal tool. Existing Pandas toolkits are disa"
---
...
**Action Required:** Users must migrate to the Data Analysis internal tool available in chat conversations and agents. See the [Pandas Toolkit Migration Guide](../../migration/v2.0.1/pandas-toolkit-migration) for step-by-step migration instructions.
</Warning>
...
<img src="../../img/how-tos/chat-conversations/internal tools/data-analysis/data-analysis-enable-chat.gif" alt="Internal Tools Button" width="700" />
...
<img src="../../img/how-tos/chat-conversations/internal tools/data-analysis/data-analysis-enable-agent.gif" alt="Enable Agent" width="700" />
---
...
<Accordion title="Data Analysis tool requires file access">
**Possible causes:**
