---
title: "Agents and Pipelines History"
description: "The Run History panel in Agents and Pipelines allows you to view and review all past execution runs of your agent or pipeline. This feature provides a complete "
---
...
5. The page is replaced by the **Run History** panel. Click the **✕ (Close)** button in the top-left to return.
     ...
     <img src="../../img/how-tos/agents-pipelines/agents-pipelines-history/agent-history.gif" alt="Agent History" />
...
5. The page is replaced by the **Run History** panel. Click the **✕ (Close)** button in the top-left to return.
     ...
     <img src="../../img/how-tos/agents-pipelines/agents-pipelines-history/pipeline-history.gif" alt="Pipeline History" />
...
The Run History panel replaces the current page view and has a **two-panel layout**: a header bar at the top with a close button and "Run History" title, a left panel listing all past runs, and a right panel showing the selected conversation replay.
     ...
     <img src="../../img/how-tos/agents-pipelines/agents-pipelines-history/history-tab-view.png" alt="Hystory Tab View" />
...
6. Click **✕ (Close)** when done to return to the agent/pipeline page
     ...
     <img src="../../img/how-tos/agents-pipelines/agents-pipelines-history/view-run.gif" alt="View-run" />
...
5. Share the link — when opened it navigates directly to the Run History panel with that run selected
     ...
     <img src="../../img/how-tos/agents-pipelines/agents-pipelines-history/copy-run-agent.gif" alt="Copy Run Link" />
...
5. The run is permanently removed from history
     ...
     <img src="../../img/how-tos/agents-pipelines/agents-pipelines-history/remove-run.gif" alt="Deleting a Run" />
...
<Warning title="What is restored">
...
<Accordion title="No History Entries Appear">
...
<Accordion title="Selected Run Shows No Messages">
...
<Accordion title="Cannot Delete a Run">
...
<Accordion title="List Not Loading More Runs">
...
<Accordion title="Duration Shows Unusual Values">
...
- [Agents Menu](../../menus/agents) - Learn about managing agents
- [Pipelines Menu](../../menus/pipelines) - Learn about managing pipelines
- [Entity Versioning](entity-versioning) - Understanding version management
</Info>
