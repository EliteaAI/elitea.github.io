...
<Warning title="Availability">
	...
	Indexing tools are available in the Next environment (Release 1.7.0) and replace legacy Datasources/Datasets. For context, see [Release Notes 1.7.0](../../release-notes/archived/rn13#indexing-dedicated-toolkit-indexes-tab) and the [Indexing Overview](./indexing-overview).
...
- Known limitations and workarounds: see [Release Notes 1.7.0](../../release-notes/rn_current#known-issues).

<Info title="Related guides">
- [Indexing Overview](./indexing-overview)
- [How tocreate and use Indexes](using-indexes-tab-interface)
