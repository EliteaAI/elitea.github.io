...
description: "Indexing feature and tools are available in the Next environment as part of the 1.7.0 release. They replace the legacy Datasources/Datasets feature. As of Relea"
---
...
<Note title="Replacement for datasets">
