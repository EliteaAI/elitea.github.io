---
title: "How to Test Toolkit Tools"
description: "The Test Settings panel provides a powerful interface for testing toolkit tools directly from the Toolkit detailed page. This feature allows you to validate too"
---
...
<Tip title="Recommended Settings for Testing">
...
<Note title="Session-Based History">
...
<Accordion title="Scenario 1: Testing GitHub Create Branch">
...
<Accordion title="Scenario 2: Testing Jira Issue Creation">
...
<Accordion title="Scenario 3: Testing Confluence Page Creation">
...
<Tip title="Confluence Content Format">
...
* **[Create a Credential](../../getting-started/create-credential)** — How to configure authentication credentials
* **[AI Configuration](../../menus/settings/ai-configuration)** — Set up LLM models and embedding configurations
* **[Agents Menu](../../menus/agents)** — Create agents that use your tested toolkits
* **[Chat Menu](../../menus/chat)** — Use toolkits in conversations
