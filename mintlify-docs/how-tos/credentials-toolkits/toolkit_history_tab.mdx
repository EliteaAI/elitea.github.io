...
description: "The Run History panel is a feature within the Toolkit detail page that provides a comprehensive record of all toolkit execution runs. It enables users to track,"
---
...
<Info title="History Availability">
...
5. The two-column layout is replaced by the **Run History** panel. Click the **✕ (Close)** button to return to the Configuration page.
     ...
     <img src="../../img/how-tos/credentials-toolkits/toolkit-history/access-history-tab.gif" alt="Accessing History" />

<Tip title="Right panel must be visible">
...
<img src="../../img/how-tos/credentials-toolkits/toolkit-history/toolkit-history-tab.png" alt="Run History View" />
...
<Note title="Duration Calculation">
...
<Note title="No Restore conversation">
...
- Any errors encountered with stack traces
     ...
     <img src="../../img/how-tos/credentials-toolkits/toolkit-history/run-details.gif" alt="Run details" />

<Note title="Tracked Executions">
...
3. **Descending** (longest first): Slowest runs appear at the top
     ...
     <img src="../../img/how-tos/credentials-toolkits/toolkit-history/history-sorting.gif" alt="Sorting" />
...
6. Share the link — when opened it navigates directly to the Run History panel with that run selected
     ...
     <img src="../../img/how-tos/credentials-toolkits/toolkit-history/history-copy.gif" alt="Copy" />
...
6. **Run Removed**: The row disappears from the history list
     ...
     <img src="../../img/how-tos/credentials-toolkits/toolkit-history/history-delete.gif" alt="Delete" />

---

## Common Use Cases

<Accordion title="Debugging a Failed Run">
...
<Accordion title="Verifying Toolkit Changes">
...
<Accordion title="Learning and Training">
...
- [Creating and Managing Toolkits](../../menus/toolkits) - Learn how to create and configure toolkits
- [Testing Toolkits](how-to-test-toolkit-tools) - Execute toolkit operations using Test Settings
- [Agents and Pipelines History](../agents-pipelines/agents-pipelines-history) - Track agent and pipeline execution history
- [Index History Tab](../indexing/using-indexes-tab-interface#reviewing-index-history) - Track indexing operations in the Indexes tab
</Info>
