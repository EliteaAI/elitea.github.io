...
<Note title="Generate System Prompt Example">
...
<Note title="Generate Tiered Discount Code">
...
<Note title="Generate User Story Template">
...
<Note title="Generate Router Condition">
...
<Note title="Generate Decision Description">
...
<Note title="Generate F-String Review Message">
...
<Note title="Generate Processing Summary (Type: F-String)">
