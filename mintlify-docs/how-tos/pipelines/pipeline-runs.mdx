---
title: "Pipeline Runs"
description: "Pipeline runs represent the execution of your workflow, capturing the complete execution state and progression through nodes. Each run maintains a detailed time"
---
...
<Info title="Run Execution Methods">
...
|-------|------------------|-------------|-------------------|
| **In Progress** | ![In progress](../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/in-progress.png) | Pipeline is actively executing nodes | Stop execution |
| **Completed** | ![In progress](../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/completed.png) | All nodes executed successfully | View details, Delete run |
| **Error** | ![In progress](../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/error.png) | Execution failed with an exception | View error details, Delete run |
| **Stopped** | ![In progress](../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/stopped.png) | Manually stopped by user | View partial results, Delete run |

<Info title="Run State Visibility">
...
* **Multiple Runs**: Shows current run + history icon (🕐 clock icon) to access previous runs
    ...
    * Each run in the dropdown can be opened (click run name) or deleted (click delete icon)
    ...
    <img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/history-icon.gif" alt="History" width="300" />
...
5. View Run Chipset and click run name for details
    ...
    <img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/run-from-chat.gif" alt="Chat Run" width="600" />

<Tip title="Chat to Canvas Workflow">
...
2. **Timeline Section**
    ...
    * **Status Indicator**: Real-time status of the current node
    ...
    |--------|-------------|------------------|
    | **In Progress** | Node is actively executing | ![In progress](../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/inprogress-indicator.png) |
    | **Completed** | Node finished successfully | ![In progress](../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/completed-indicator.png) |
    | **Error** | Node failed with an error | ![In progress](../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/error-indicator.png) |
    | **Stopped** | Manually stopped by user | ![In progress](../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/stopped-indicator.png) |
...
3. **States Section**
    ...
    * Full-screen view button for detailed inspection
    ...
    <img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/run-details.gif" alt="Run Details" width="600" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/error-handling.png" alt="Error Hnadling" width="500" />

---

## Best Practices

<Accordion title="State Variable Management">
...
<Accordion title="Using Interrupt Points Effectively">
Use interrupts for:
...
<Accordion title="Run Monitoring Tips">
**During Development:**
...
<Accordion title="Hardcoding State Variables for Debugging">
...
<Tip title="Combining with Interrupts">
...
<Accordion title="Error: Entry Point Not Defined">
**Error Message:**
```
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/pipeline-runs/make-entrypoint.gif" alt="Entry Point Configuration" width="350" />
</Accordion>

<Accordion title="Error: Missing Required Parameter">
**Error Message:**
```
...
<Accordion title="Error: Node Transition Undefined">
**Error Message:**
```
...
<Accordion title="Error: State Variable Type Mismatch">
**Error Message:**
```
...
---
<Accordion title="Interpreting Error Messages">
...
* **[Pipeline Overview](overview)** - Understanding pipeline concepts and architecture
* **[Pipeline Nodes](nodes/overview)** - Complete guide to all node types
* **[Pipeline States](states)** - Managing state variables and data flow
* **[Flow Editor](flow-editor)** - Visual pipeline design and editing
* **[YAML Configuration](yaml)** - Text-based pipeline definition
* **[Agents and Pipelines History](../agents-pipelines/agents-pipelines-history)** - Detailed history tab guide
