...
description: "State is the memory of your pipeline—a structured storage system that holds all information gathered and used during pipeline execution. Think of state as a col"
---
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/open-states-sidebar.png" alt="Opening States Sidebar" />

<Note title="Flow Mode Only">
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/default-states-toggles.png" alt="Default States" />

<Warning title="New Pipeline Behavior">
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/add-custom-state.png" alt="Adding Custom State" />
...
<Warning title="Invalid State Names">
...
<Tip title="Special List Type: messages">
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/state-types.png" alt="State types" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/default-value-input.png" alt="Default Value Input" />
...
<Info title="Related">
- **[Nodes Overview](nodes/overview)** - Learn how different node types read from and write to state
- **[State Modifier Node](nodes/utility-nodes#state-modifier-node)** - Advanced state manipulation with Jinja2 templates
- **[Connections](nodes-connectors)** - Understand how data flows between nodes through state
- **[Entry Point](entry-point)** - Define pipeline starting point and initial state
- **[YAML Configuration](yaml)** - See complete state definition syntax
- **[Code Node](nodes/execution-nodes#code-node)** - Access state via `alita_state` in Python code
</Info>
