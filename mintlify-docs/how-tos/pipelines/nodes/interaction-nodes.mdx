...
description: "Interaction Nodes enable your pipeline to communicate with AI models and delegate tasks to specialized agents. These nodes form the \"intelligent\" layer of you"
---
...
<Note title="Migrating from v1.x LLM Nodes">
If you have existing pipelines with old LLM node format, see the [v2.0.0 Migration Guide](../../../migration/v2.0.0/update-llm-nodes) for updating to the new System/Task structure.
</Note>
...
<Info title="Agent Selection and Input Mapping">
...
<Warning title="Add Agents to Pipeline First">
...
- **[Execution Nodes](execution-nodes)** - Call external tools and execute code
...
- **[Updating LLM Nodes (v2.0.0 Migration)](../../../migration/v2.0.0/update-llm-nodes)** - Guide for migrating old LLM nodes to new format
</Info>
