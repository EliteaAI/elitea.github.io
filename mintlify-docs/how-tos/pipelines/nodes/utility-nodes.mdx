---
title: "Utility Nodes"
description: "Utility Nodes provide specialized functionality for state management and workflow composition. These nodes form the \"supporting infrastructure\" of your pipeli"
---
...
<Note title="Supporting Infrastructure">
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/statemodifier-node-add.gif" alt="State Modifier Node Interface" />
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/statemodifier-node-interface.png" alt="State Modifier Node Interface" />

<Warning title="Variable Cleanup">
...
<Accordion title="Basic Example: Simple Greeting">
```yaml
nodes:
  - id: StateModifier 1
    type: state_modifier
...
<Accordion title="Advanced Example: Counter Increment with Type Conversion">
...
<Accordion title="Complex Example: Aggregating Multi-Step Responses">
...
<Accordion title="Custom Filters Example: JSON Processing and Text Splitting">
...
<Accordion title="Text Extraction Example: Cleaning Status Value">
...
<Accordion title="Cleanup Example: Resetting Variables by Type">
...
<Note title="Jinja2 Template Features">
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/printer-node-add.gif" alt="Printer Node Interface" />
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/printer-node-interface.png" alt="Printer" />

**YAML Configuration Examples**

<Accordion title="Simple Text (Type: Fixed)">
...
<Accordion title="Show Variable Value (Type: Variable)">
...
<Accordion title="Formatted Text (Type: F-String)">
...
- **[Entry Point](../entry-point)** - Define pipeline starting point
- **[Flow Editor](../flow-editor)** - Visual workflow design
- **[YAML Configuration](../yaml)** - Text-based pipeline definition
- **[Control Flow Nodes](control-flow-nodes)** - Decision and routing nodes
- **[Execution Nodes](execution-nodes)** - LLM, Tool, and Code nodes
- **[State Management](../states)** - Understanding state variables
</Info>
