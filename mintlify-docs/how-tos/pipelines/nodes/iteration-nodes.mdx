...
description: "Iteration Nodes enable your pipeline to perform repetitive tasks, processing multiple items systematically. These nodes form the \"looping\" layer of your workf"
---
...
<Note title="Understanding Iteration">
...
<Warning title="Structured Output Requirements">
...
<Warning title="Performance Considerations">
...
<Tip title="Structured Output for List Generation">
...
<Warning title="Variables Mapping Requirement">
...
- **[Execution Nodes](execution-nodes)** - Function, Tool, Code nodes for task execution
- **[Control Flow Nodes](control-flow-nodes)** - Router, Condition, Decision nodes
