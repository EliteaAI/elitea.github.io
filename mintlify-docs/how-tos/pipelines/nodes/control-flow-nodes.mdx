...
description: "Control Flow Nodes enable your pipeline to make decisions, route execution down different paths, and implement conditional logic. These nodes form the \"decisio"
---
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/router-node-add.gif" alt="Router Node Interface" />
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/router-node-interface.png" alt="Router Node Interface" />


<Warning title="Route Name Matching">
...
<Accordion title="Jinja Syntax Examples">
...
<Tip title="Router Node for Loops">
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/decision-node-add.gif" alt="Decision Node Interface" />
...
<Note title="Decision Node Chaining Restriction">
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/decision-node-interface.png" alt="Decision Node Interface" />
**YAML Configuration**
...
<Info title="LLM Decision Process">
...
<img src="../../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/hitl-node.png" alt="hitl" width="300" />
...
<Warning title="Edit Route Constraints">
...
<Accordion title="1. Place HITL Before Irreversible Actions">
...
<Accordion title="2. Use F-String to Show Relevant Context">
...
<Accordion title="3. Route Edit Back Through Processing When Needed">
...
<Accordion title="4. Always Configure the Reject Route">
...
<Accordion title="Example 1: Content Approval Workflow">
...
<Accordion title="Example 2: Jira Ticket Approval Before Creation">
...
- **[Execution Nodes](execution-nodes)** - Function, Tool, Code, and Custom nodes
