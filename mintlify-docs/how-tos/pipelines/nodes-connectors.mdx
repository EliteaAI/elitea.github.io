...
description: "Node connectors link nodes together to define your pipeline's execution flow. They determine which node runs next, how data flows between nodes, and when the pi"
---
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/node-menu-options.png" alt="Make entrypoint menu option" />
...
<Note title="Complete Execution Paths">
Every execution path must eventually reach END. Paths without termination may cause unexpected behavior.
</Note>

<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/end-node.gif" alt="Multiple paths converging to END" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/multiple-inputs.png" alt="Multiple nodes connecting to single node" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/drag-from-node.gif" alt="Dragging connector between nodes" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/drag-connector.gif" alt="Dragging connector between nodes" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/interrupt.png" alt="Interrupt Before toggle" />
...
<img src="../../img/how-tos/agents-pipelines/pipeline-building-blocks/nodes/pattern-linear.png" alt="Linear flow diagram" />
