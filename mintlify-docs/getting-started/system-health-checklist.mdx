---
title: "System Health & Troubleshooting Guide"
description: "A comprehensive guide to verify your ELITEA system health and quickly resolve common issues."
---
...
- **Green dot** = Connected and ready <img src="../img/getting-started/redesign/troubleshooting/socket-connection.png" alt="Connected" width="45" />
- **Red dot** = Disconnected - check your network connection <img src="../img/getting-started/redesign/troubleshooting/socket-disconnected.png" alt="Disconnected" width="45" />
...
<img src="../img/getting-started/redesign/troubleshooting/test-connection-ok.png" alt="Connected" width="300" /> <img src="../img/getting-started/redesign/troubleshooting/test-connection-error.png" alt="Connected" width="317" />

**✔️ MCP Integration**

MCP status shows connected (if using MCP features)

If you're using Model Context Protocol (MCP) features, verify the MCP status indicator shows as connected. This ensures proper communication with MCP servers for enhanced functionality. If not connected, you need to run your MCP server first. See [how to create and use MCP client](../integrations/mcp/create-and-use-client-stdio) for setup instructions.

- **Connected and ready** 

<img src="../img/getting-started/redesign/troubleshooting/mcp-connected.png" alt="Connected" width="300" />

- **Disconnected - MCP server not running** 

<img src="../img/getting-started/redesign/troubleshooting/mcp-disconnected.png" alt="disconnected" width="300" />
...
For detailed setup instructions, see [How to create and use indexes](../how-tos/indexing/using-indexes-tab-interface).
...
<Accordion title="**Agent stops or provides incomplete responses**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §1](../support/troubleshooting#1-agent-stops-without-answer-or-provides-truncated-response)
</Accordion>

<Accordion title="**Content policy violation (400 error)**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §8](../support/troubleshooting#8-content-policy-violations)
</Accordion>
...
**Related:** [Troubleshooting Guide §9](../support/troubleshooting#9-rate-limit-exceeded-429-error-code)
</Accordion>

<Accordion title="**Context length exceeded (400 error)**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §10](../support/troubleshooting#10-context-length-exceeded)
</Accordion>
...
<Accordion title="**Indexing fails with permission errors**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §11](../support/troubleshooting#11-indexing-access-issues)
</Accordion>

<Accordion title="**Atlassian API redirect errors (Too many redirects)**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §12](../support/troubleshooting#12-atlassian-api-connection-issues)
</Accordion>

<Accordion title="**Authentication errors (401/403 Unauthorized)**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §13](../support/troubleshooting#13-atlassian-authentication-token-issues)
</Accordion>

<Accordion title="**Toolkit configuration validation errors**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §14](../support/troubleshooting#14-toolkit-resource-limit-issues)
</Accordion>
...
<Accordion title="**Entry point not defined error**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §2](../support/troubleshooting#2-entry-point-not-defined)
</Accordion>

<Accordion title="**Pipeline input processing issues**">
**Symptoms:**
...
**Related:** [Troubleshooting Guide §6](../support/troubleshooting#6-nodes-not-receiving-input-data)
</Accordion>
...
* **[Full Troubleshooting Guide](../support/troubleshooting)**: Detailed error messages with screenshots
* **[FAQs](../support/faqs)**: Frequently asked questions
* **[Contact Support](../support/contact-support)**: Get additional help
</Info>
