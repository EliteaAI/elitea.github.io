---
title: "Configure EPAM AI DIAL Keys (Next Environment)"
description: "This quick guide shows how to request an EPAM AI DIAL API key and configure it in ELITEA (Next) so you can use dedicated LLM models without hitting shared limit"
---
