---
title: "Quick Start"
description: "Get started with ELITEA by sending your first chat message. This hands-on guide will walk you through the essentials of using Chat, the heart of the ELITEA plat"
---
...
<Info title="Chat Interface Overview">
...
<img src="../img/getting-started/redesign/quick-start/first-message.gif" alt="First Message" />

<Check title="Success Indicator">
...
<Info title="Supported File Types">
...
<img src="../img/getting-started/redesign/quick-start/attach-files.gif" alt="Attach Files" />
...
5. **Use Your Agent**: 
 ...
 <img src="../img/getting-started/redesign/quick-start/create-agent.gif" alt="Create Agent" />

<Info title="Benefits of Agent Creation">
...
<img src="../img/getting-started/redesign/quick-start/use-public-agents.gif" alt="Public agent" />

<Tip title="Learning from Public Agents">
...
* **[Chat Guide](../menus/chat)**: Explore all chat features in detail
* **[Create an Agent](../how-tos/chat-conversations/how-to-create-and-edit-agents-from-canvas)**: Learn advanced agent creation
* **[Use Public Items from Chat](../how-tos/chat-conversations/use-public-items-from-chat)**: Access and use shared agents, toolkits, and prompts
* **[Connect Toolkits](connect-toolkits-quick-start)**: Connect more external services
* **[Create Credentials](create-credential)**: Manage service credentials
