---
title: "Quick Start: Connect Toolkits"
description: "Learn how to connect external tools and services to ELITEA through toolkits. This guide covers the most commonly used integrations: Jira, Confluence, GitHub, Fi"
---
...
<img src="../img/getting-started/redesign/quick-start/connect-toolkit.gif" alt="Connect Toolkit" />

<Tip title="Common Tools">
...
<img src="../img/getting-started/redesign/connect-toolkits/connect-confluence.gif" alt="Confluence" />
...
5. **Use it**:
      ...
      * The toolkit will fetch and display the secret creation documentation
      ...
      <img src="../img/getting-started/redesign/connect-toolkits/github-connect.gif" alt="GitHub" />
...
5. **Use it**:
     ...
     <img src="../img/getting-started/redesign/connect-toolkits/figma-connect.gif" alt="Figma" />


<Info title="Getting Your Figma Token">
...
5. **Use it**:
     ...
     <img src="../img/getting-started/redesign/connect-toolkits/testrail-connect.gif" alt="Testrail" />
...
<Info title="When to Use Artifact Toolkit">
...
4. **Use it**:
      ...
      * Example: `List all files in my artifact bucket` or `Read the contents of report.pdf`
      ...
      <img src="../img/getting-started/redesign/connect-toolkits/artifact-connect.gif" alt="Artifact" />
...
<Tip title="Quick Setup from Chat">
The easiest way to create an Artifact Toolkit is directly from chat when attaching files. See **[Send an Attachment](chat-quick-start#step-4-send-an-attachment)**.
</Tip>
...
* **[Toolkits Menu](../menus/toolkits)**: Manage and view all your toolkits
* **[Credential Configuration Guide](../how-tos/credentials-toolkits/how-to-use-credentials)**: Advanced configuration options
* **[AI Configuration](../menus/settings/ai-configuration)**: Configure PgVector, embedding models, and LLM settings
* **[Chat Menu](../menus/chat)**: Explore all chat features in detail
* **[Create Secrets](create-secret)**: Securely store sensitive data
</Info>
