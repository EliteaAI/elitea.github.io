---
title: "Alita Release Notes"
description: "Alita is an innovative web application that revolutionizes how you interact with prompts. Designed as a dynamic workspace, it empowers users to create, organize"
---
...
* **User Guide**: [Alita - User Guide](../../home/introduction)
