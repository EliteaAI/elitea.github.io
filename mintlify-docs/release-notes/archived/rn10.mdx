...
For more details and practical examples, see the [Canvas User Guide](../../how-tos/chat-conversations/how-to-canvas).
...
For more details and practical examples, see the [Elitea MCP Client Integration via STDIO](../../integrations/mcp/mcp-client).
