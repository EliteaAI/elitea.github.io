...
<img src="../img/menus/agents/agents-menu-Interface.png" alt="Agents-Menu_Interface" />
...
The Agents menu is accessible from the main platform navigation. Upon entering the Agents section, you'll see a dashboard listing all created agents for your project.
  ...
  <img src="../img/menus/agents/agents-menu-navigation.gif" alt="Agents-Menu_Navigation" />
...
<img src="../img/menus/agents/agents-pin.gif" alt="Agents-Menu_Interface" />
...
<img src="../img/menus/agents/agents-create.gif" alt="Agents-Menu_Create" />
...
<img src="../img/menus/agents/agents-icon.gif" alt="Agents_icon" />
</Tip>
...
3. Each dropdown supports inline search and paginated scrolling to locate resources quickly.
     ...
     <img src="../img/menus/agents/agent-add-toolkit.gif" alt="Agents-Toolkits" />
...
3. Enable the tools you need:
     ...
     <img src="../img/menus/agents/agent-internal-tools-enable.gif" alt="Agent Python Sandbox" />
...
* **Using toolkits**: For enhancing agent's capabilities, you can integrate toolkits and provide instructions how to use them and in which order. The name of toolkit can be denoted by "", (e.g. "Access_JIRA" toolkit).
     ...
     <img src="../img/menus/agents/agents-instructions.gif" alt="Agents-Instructions" />
...
4. During execution, the placeholders are substituted with the provided values before the instructions are sent to the model.
     ...
     <img src="../img/menus/agents/agent-add-variables.gif" alt="Variables" />
...
<img src="../img/menus/agents/agents-welcome-message.gif" alt="Agents-WelcomeMessage" />

<Note title="Examples of Welcome Message">
...
<img src="../img/menus/agents/agents-conversation-starter.gif" alt="Agents-Conversation_Starter" />

<Note title="Examples of Conversation Starters">
...
2. **Adjust Model Settings** (Optional): Click the **Model Settings** icon (⚙️) next to the model selector to fine-tune the response generation. The settings vary depending on the selected model:
    ...
    * **Custom**: Manually set a specific token limit for responses
    ...
    <img src="../img/menus/agents/agent-model_settings.gif" alt="Agents-Model- Settings" />   
...
* **Message preservation**: Configure how many recent messages to always keep
     ...
     <img src="../img/how-tos/chat-conversations/context-management/agent-context-budget.gif" alt="Agent Context Budget" />
...
<img src="../img/menus/agents/agents-execution.png" alt="Agents-Execution" />
...
* **Navigate Versions**: Use the **Version** dropdown list to switch between and select different versions of the agent. This allows for easy comparison and management of various iterations.
     ...
     <img src="../img/menus/agents/agents-version-create.gif" alt="Agents-Publish" />
...
3. **Submit for Approval**:
   ...
   * The moderator will evaluate the agent version and either approve or reject the request.
     ...
     <img src="../img/menus/agents/agents-publish.gif" alt="Agents-Publish" />
...
<img src="../img/menus/agents/agent-history-tab.gif" alt="History Tab" />

<Info title="Learn More About Agent History">
