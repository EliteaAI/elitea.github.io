...
When prompted for sensitive information like API keys, passwords, or tokens, it's recommended to use **[Secrets](../getting-started/create-secret)** instead of entering plain text values. Secrets provide enhanced security for your sensitive data.
</Warning>
